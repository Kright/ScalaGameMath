...
extension(v: Vector2d)
  def xy_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.x = x; v.y = y }
  def yx_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.y = x; v.x = y }
...
extension(v: Vector3d)
  def xy_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.x = x; v.y = y }
  def xz_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.x = x; v.z = y }
  def yx_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.y = x; v.x = y }
  def yz_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.y = x; v.z = y }
  def zx_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.z = x; v.x = y }
  def zy_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.z = x; v.y = y }
  def xyz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.y = y; v.z = z }
  def xzy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.z = y; v.y = z }
  def yxz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.x = y; v.z = z }
  def yzx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.z = y; v.x = z }
  def zxy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.x = y; v.y = z }
  def zyx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.y = y; v.x = z }
...
extension(v: Vector4d)
  def xy_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.x = x; v.y = y }
  def xz_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.x = x; v.z = y }
  def xw_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.x = x; v.w = y }
  def yx_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.y = x; v.x = y }
  def yz_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.y = x; v.z = y }
  def yw_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.y = x; v.w = y }
  def zx_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.z = x; v.x = y }
  def zy_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.z = x; v.y = y }
  def zw_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.z = x; v.w = y }
  def wx_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.w = x; v.x = y }
  def wy_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.w = x; v.y = y }
  def wz_=(s: IVector2d): Unit = { val x = s.x; val y = s.y; v.w = x; v.z = y }
  def xyz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.y = y; v.z = z }
  def xyw_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.y = y; v.w = z }
  def xzy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.z = y; v.y = z }
  def xzw_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.z = y; v.w = z }
  def xwy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.w = y; v.y = z }
  def xwz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.x = x; v.w = y; v.z = z }
  def yxz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.x = y; v.z = z }
  def yxw_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.x = y; v.w = z }
  def yzx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.z = y; v.x = z }
  def yzw_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.z = y; v.w = z }
  def ywx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.w = y; v.x = z }
  def ywz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.y = x; v.w = y; v.z = z }
  def zxy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.x = y; v.y = z }
  def zxw_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.x = y; v.w = z }
  def zyx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.y = y; v.x = z }
  def zyw_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.y = y; v.w = z }
  def zwx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.w = y; v.x = z }
  def zwy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.z = x; v.w = y; v.y = z }
  def wxy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.w = x; v.x = y; v.y = z }
  def wxz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.w = x; v.x = y; v.z = z }
  def wyx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.w = x; v.y = y; v.x = z }
  def wyz_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.w = x; v.y = y; v.z = z }
  def wzx_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.w = x; v.z = y; v.x = z }
  def wzy_=(s: IVector3d): Unit = { val x = s.x; val y = s.y; val z = s.z; v.w = x; v.z = y; v.y = z }
  def xyzw_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.x = x; v.y = y; v.z = z; v.w = w }
  def xywz_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.x = x; v.y = y; v.w = z; v.z = w }
  def xzyw_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.x = x; v.z = y; v.y = z; v.w = w }
  def xzwy_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.x = x; v.z = y; v.w = z; v.y = w }
  def xwyz_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.x = x; v.w = y; v.y = z; v.z = w }
  def xwzy_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.x = x; v.w = y; v.z = z; v.y = w }
  def yxzw_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.y = x; v.x = y; v.z = z; v.w = w }
  def yxwz_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.y = x; v.x = y; v.w = z; v.z = w }
  def yzxw_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.y = x; v.z = y; v.x = z; v.w = w }
  def yzwx_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.y = x; v.z = y; v.w = z; v.x = w }
  def ywxz_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.y = x; v.w = y; v.x = z; v.z = w }
  def ywzx_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.y = x; v.w = y; v.z = z; v.x = w }
  def zxyw_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.z = x; v.x = y; v.y = z; v.w = w }
  def zxwy_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.z = x; v.x = y; v.w = z; v.y = w }
  def zyxw_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.z = x; v.y = y; v.x = z; v.w = w }
  def zywx_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.z = x; v.y = y; v.w = z; v.x = w }
  def zwxy_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.z = x; v.w = y; v.x = z; v.y = w }
  def zwyx_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.z = x; v.w = y; v.y = z; v.x = w }
  def wxyz_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.w = x; v.x = y; v.y = z; v.z = w }
  def wxzy_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.w = x; v.x = y; v.z = z; v.y = w }
  def wyxz_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.w = x; v.y = y; v.x = z; v.z = w }
  def wyzx_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.w = x; v.y = y; v.z = z; v.x = w }
  def wzxy_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.w = x; v.z = y; v.x = z; v.y = w }
  def wzyx_=(s: IVector4d): Unit = { val x = s.x; val y = s.y; val z = s.z; val w = s.w; v.w = x; v.z = y; v.y = z; v.x = w }
