...
case class Quaternion(
  ...
  infix def multiplyElementwise(v: Multivector): Quaternion =
    Quaternion(
      s = s * v.s,
      xy = v.xy * xy,
      xz = v.xz * xz,
  ...
  infix def multiplyElementwise(v: Motor): Quaternion =
    Quaternion(
      s = s * v.s,
      xy = v.xy * xy,
      xz = v.xz * xz,
  ...
  infix def multiplyElementwise(v: Bivector): Quaternion =
    Quaternion(
      s = 0.0,
      xy = v.xy * xy,
      xz = v.xz * xz,
  ...
  infix def cross(v: Quaternion): Quaternion =
    Quaternion(
      s = 0.0,
      xy = (v.xz * yz - v.yz * xz),
      xz = (v.yz * xy - v.xy * yz),
  ...
  infix def antiDot(v: Bivector): Quaternion =
    Quaternion(
      s = 0.0,
      xy = -s * v.wz,
      xz = s * v.wy,
  ...
  infix def antiDot(v: QuaternionDual): Quaternion =
    Quaternion(
      s = s * v.i,
      xy = (v.i * xy - s * v.wz),
      xz = (s * v.wy + v.i * xz),
