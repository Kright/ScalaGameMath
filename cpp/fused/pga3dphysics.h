...
namespace pga3d {
    constexpr Multivector Multivector::dot(const Multivector& b) const noexcept { return {
        .s = (b.s * s + b.x * x + b.y * y + b.z * z - b.xy * xy - b.xyz * xyz - b.xz * xz - b.yz * yz),
        .w = (b.i * xyz + b.s * w + b.w * s + b.x * wx + b.y * wy + b.z * wz - b.wx * x - b.wxy * xy - b.wxz * xz - b.wy * y - b.wyz * yz - b.wz * z - b.xy * wxy - b.xyz * i - b.xz * wxz - b.yz * wyz),
        .x = (b.s * x + b.x * s + b.y * xy + b.z * xz - b.xy * y - b.xyz * yz - b.xz * z - b.yz * xyz),
        .y = (b.s * y + b.xy * x + b.xyz * xz + b.xz * xyz + b.y * s + b.z * yz - b.x * xy - b.yz * z),
        .z = (b.s * z + b.xz * x + b.yz * y + b.z * s - b.x * xz - b.xy * xyz - b.xyz * xy - b.y * yz),
        .wx = (b.s * wx + b.wx * s + b.wxy * y + b.wxz * z + b.y * wxy + b.z * wxz - b.i * yz - b.yz * i),
        .wy = (b.i * xz + b.s * wy + b.wy * s + b.wyz * z + b.xz * i + b.z * wyz - b.wxy * x - b.x * wxy),
        .wz = (b.s * wz + b.wz * s - b.i * xy - b.wxz * x - b.wyz * y - b.x * wxz - b.xy * i - b.y * wyz),
        .xy = (b.s * xy + b.xy * s + b.xyz * z + b.z * xyz),
        .xz = (b.s * xz + b.xz * s - b.xyz * y - b.y * xyz),
        .yz = (b.s * yz + b.x * xyz + b.xyz * x + b.yz * s),
        .wxy = (b.s * wxy + b.wxy * s + b.z * i - b.i * z),
        .wxz = (b.i * y + b.s * wxz + b.wxz * s - b.y * i),
        .wyz = (b.s * wyz + b.wyz * s + b.x * i - b.i * x),
        .xyz = (b.s * xyz + b.xyz * s),
        .i = (b.i * s + b.s * i)
    }; }

    constexpr Motor Motor::dot(const Motor& b) const noexcept { return {
        .s = (b.s * s - b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = (b.s * wx + b.wx * s - b.i * yz - b.yz * i),
        .wy = (b.i * xz + b.s * wy + b.wy * s + b.xz * i),
        .wz = (b.s * wz + b.wz * s - b.i * xy - b.xy * i),
        .xy = (b.s * xy + b.xy * s),
        .xz = (b.s * xz + b.xz * s),
        .yz = (b.s * yz + b.yz * s),
        .i = (b.i * s + b.s * i)
    }; }
    constexpr Multivector Motor::dot(const Plane& b) const noexcept { return {
        .s = 0.0,
        .w = (b.w * s + b.x * wx + b.y * wy + b.z * wz),
        .x = (b.x * s + b.y * xy + b.z * xz),
        .y = (b.y * s + b.z * yz - b.x * xy),
    ...
    constexpr Motor Motor::dot(const Bivector& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = (b.wx * s - b.yz * i),
        .wy = (b.wy * s + b.xz * i),
        .wz = (b.wz * s - b.xy * i),
    ...
    constexpr Multivector Motor::dot(const ProjectivePoint& b) const noexcept { return {
        .s = 0.0,
        .w = (b.x * yz + b.z * xy - b.w * i - b.y * xz),
        .x = -b.w * yz,
        .y = b.w * xz,
    ...
    constexpr Motor Motor::dot(const Quaternion& b) const noexcept { return {
        .s = (b.s * s - b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = (b.s * wx - b.yz * i),
        .wy = (b.s * wy + b.xz * i),
        .wz = (b.s * wz - b.xy * i),
    ...
    constexpr Motor Motor::dot(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * s,
        .wx = (b.s * wx + b.wx * s),
        .wy = (b.s * wy + b.wy * s),
        .wz = (b.s * wz + b.wz * s),
    ...
    constexpr Motor Motor::dot(const Translator& b) const noexcept { return {
        .s = s,
        .wx = (wx + b.wx * s),
        .wy = (wy + b.wy * s),
        .wz = (wz + b.wz * s),
    ...
    constexpr Multivector Motor::dot(const Vector& b) const noexcept { return {
        .s = 0.0,
        .w = (b.x * yz + b.z * xy - b.y * xz),
        .x = 0.0,
        .y = 0.0,
    ...
    constexpr Multivector Motor::dot(const Point& b) const noexcept { return {
        .s = 0.0,
        .w = (-i + b.x * yz + b.z * xy - b.y * xz),
        .x = -yz,
        .y = xz,
    ...
    constexpr Multivector Motor::dot(const PlaneIdeal& b) const noexcept { return {
        .s = 0.0,
        .w = (b.x * wx + b.y * wy + b.z * wz),
        .x = (b.x * s + b.y * xy + b.z * xz),
        .y = (b.y * s + b.z * yz - b.x * xy),
    ...
    constexpr Motor Motor::dot(const BivectorBulk& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = -b.yz * i,
        .wy = b.xz * i,
        .wz = -b.xy * i,
    ...
    constexpr BivectorWeight Motor::dot(const BivectorWeight& b) const noexcept { return {
        .wx = b.wx * s,
        .wy = b.wy * s,
        .wz = b.wz * s
    }; }
    constexpr Motor Motor::dot(const PseudoScalar& b) const noexcept { return {
        .s = 0.0,
        .wx = -b.i * yz,
        .wy = b.i * xz,
        .wz = -b.i * xy,
    ...
    constexpr Multivector Motor::dot(const PointCenter& b) const noexcept { return {
        .s = 0.0,
        .w = -i,
        .x = -yz,
        .y = xz,
    ...
    constexpr Multivector Plane::dot(const Motor& b) const noexcept { return {
        .s = 0.0,
        .w = (b.s * w - b.wx * x - b.wy * y - b.wz * z),
        .x = (b.s * x - b.xy * y - b.xz * z),
        .y = (b.s * y + b.xy * x - b.yz * z),
    ...
    constexpr Plane Plane::dot(const Bivector& b) const noexcept { return {
        .x = (-b.xy * y - b.xz * z),
        .y = (b.xy * x - b.yz * z),
        .z = (b.xz * x + b.yz * y),
        .w = (-b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr Bivector Plane::dot(const ProjectivePoint& b) const noexcept { return {
        .wx = (b.y * z - b.z * y),
        .wy = (b.z * x - b.x * z),
        .wz = (b.x * y - b.y * x),
        .xy = b.w * z,
    ...
    constexpr Plane Plane::dot(const Quaternion& b) const noexcept { return {
        .x = (b.s * x - b.xy * y - b.xz * z),
        .y = (b.s * y + b.xy * x - b.yz * z),
        .z = (b.s * z + b.xz * x + b.yz * y),
        .w = b.s * w
    }; }
    constexpr Plane Plane::dot(const ProjectiveTranslator& b) const noexcept { return {
        .x = b.s * x,
        .y = b.s * y,
        .z = b.s * z,
        .w = (b.s * w - b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr Plane Plane::dot(const Translator& b) const noexcept { return {
        .x = x,
        .y = y,
        .z = z,
        .w = (w - b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr BivectorWeight Plane::dot(const Vector& b) const noexcept { return {
        .wx = (b.y * z - b.z * y),
        .wy = (b.z * x - b.x * z),
        .wz = (b.x * y - b.y * x)
    }; }
    constexpr Bivector Plane::dot(const Point& b) const noexcept { return {
        .wx = (b.y * z - b.z * y),
        .wy = (b.z * x - b.x * z),
        .wz = (b.x * y - b.y * x),
        .xy = z,
    ...
    constexpr PlaneIdeal Plane::dot(const BivectorBulk& b) const noexcept { return {
        .x = (-b.xy * y - b.xz * z),
        .y = (b.xy * x - b.yz * z),
        .z = (b.xz * x + b.yz * y)
    }; }
    constexpr Plane Plane::dot(const BivectorWeight& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (-b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr Vector Plane::dot(const PseudoScalar& b) const noexcept { return {
        .x = b.i * x,
        .y = b.i * y,
        .z = b.i * z
    }; }
    constexpr BivectorBulk Plane::dot(const PointCenter& b) const noexcept { return {
        .xy = z,
        .xz = -y,
        .yz = x
    }; }

    constexpr Motor Bivector::dot(const Motor& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = (b.s * wx - b.i * yz),
        .wy = (b.i * xz + b.s * wy),
        .wz = (b.s * wz - b.i * xy),
    ...
    constexpr Plane Bivector::dot(const Plane& b) const noexcept { return {
        .x = (b.y * xy + b.z * xz),
        .y = (b.z * yz - b.x * xy),
        .z = (-b.x * xz - b.y * yz),
        .w = (b.x * wx + b.y * wy + b.z * wz)
    ...
    constexpr Plane Bivector::dot(const ProjectivePoint& b) const noexcept { return {
        .x = -b.w * yz,
        .y = b.w * xz,
        .z = -b.w * xy,
        .w = (b.x * yz + b.z * xy - b.y * xz)
    }; }
    constexpr Motor Bivector::dot(const Quaternion& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = b.s * wx,
        .wy = b.s * wy,
        .wz = b.s * wz,
    ...
    constexpr Bivector Bivector::dot(const ProjectiveTranslator& b) const noexcept { return {
        .wx = b.s * wx,
        .wy = b.s * wy,
        .wz = b.s * wz,
        .xy = b.s * xy,
    ...
    constexpr Bivector Bivector::dot(const Translator& b) const noexcept { return {
        .wx = wx,
        .wy = wy,
        .wz = wz,
        .xy = xy,
    ...
    constexpr Plane Bivector::dot(const Vector& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (b.x * yz + b.z * xy - b.y * xz)
    }; }
    constexpr Plane Bivector::dot(const Point& b) const noexcept { return {
        .x = -yz,
        .y = xz,
        .z = -xy,
        .w = (b.x * yz + b.z * xy - b.y * xz)
    }; }
    constexpr Plane Bivector::dot(const PlaneIdeal& b) const noexcept { return {
        .x = (b.y * xy + b.z * xz),
        .y = (b.z * yz - b.x * xy),
        .z = (-b.x * xz - b.y * yz),
        .w = (b.x * wx + b.y * wy + b.z * wz)
    ...
    constexpr BivectorWeight Bivector::dot(const PseudoScalar& b) const noexcept { return {
        .wx = -b.i * yz,
        .wy = b.i * xz,
        .wz = -b.i * xy
    }; }
    constexpr PlaneIdeal Bivector::dot(const PointCenter& b) const noexcept { return {
        .x = -yz,
        .y = xz,
        .z = -xy
    }; }

    constexpr Multivector ProjectivePoint::dot(const Motor& b) const noexcept { return {
        .s = 0.0,
        .w = (b.i * w + b.xy * z + b.yz * x - b.xz * y),
        .x = -b.yz * w,
        .y = b.xz * w,
    ...
    constexpr Bivector ProjectivePoint::dot(const Plane& b) const noexcept { return {
        .wx = (b.z * y - b.y * z),
        .wy = (b.x * z - b.z * x),
        .wz = (b.y * x - b.x * y),
        .xy = b.z * w,
    ...
    constexpr Plane ProjectivePoint::dot(const Bivector& b) const noexcept { return {
        .x = -b.yz * w,
        .y = b.xz * w,
        .z = -b.xy * w,
        .w = (b.xy * z + b.yz * x - b.xz * y)
    ...
    constexpr Multivector ProjectivePoint::dot(const Quaternion& b) const noexcept { return {
        .s = 0.0,
        .w = (b.xy * z + b.yz * x - b.xz * y),
        .x = -b.yz * w,
        .y = b.xz * w,
    ...
    constexpr ProjectivePoint ProjectivePoint::dot(const ProjectiveTranslator& b) const noexcept { return {
        .x = b.s * x,
        .y = b.s * y,
        .z = b.s * z,
        .w = b.s * w
    }; }
    constexpr ProjectivePoint ProjectivePoint::dot(const Translator& b) const noexcept { return {
        .x = x,
        .y = y,
        .z = z,
        .w = w
    ...
    constexpr Bivector ProjectivePoint::dot(const PlaneIdeal& b) const noexcept { return {
        .wx = (b.z * y - b.y * z),
        .wy = (b.x * z - b.z * x),
        .wz = (b.y * x - b.x * y),
        .xy = b.z * w,
    ...
    constexpr Plane ProjectivePoint::dot(const BivectorBulk& b) const noexcept { return {
        .x = -b.yz * w,
        .y = b.xz * w,
        .z = -b.xy * w,
        .w = (b.xy * z + b.yz * x - b.xz * y)
    }; }
    constexpr Plane ProjectivePoint::dot(const PseudoScalar& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = b.i * w
    ...
    constexpr Motor Quaternion::dot(const Motor& b) const noexcept { return {
        .s = (b.s * s - b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = (b.wx * s - b.i * yz),
        .wy = (b.i * xz + b.wy * s),
        .wz = (b.wz * s - b.i * xy),
    ...
    constexpr Plane Quaternion::dot(const Plane& b) const noexcept { return {
        .x = (b.x * s + b.y * xy + b.z * xz),
        .y = (b.y * s + b.z * yz - b.x * xy),
        .z = (b.z * s - b.x * xz - b.y * yz),
        .w = b.w * s
    }; }
    constexpr Motor Quaternion::dot(const Bivector& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = b.wx * s,
        .wy = b.wy * s,
        .wz = b.wz * s,
    ...
    constexpr Multivector Quaternion::dot(const ProjectivePoint& b) const noexcept { return {
        .s = 0.0,
        .w = (b.x * yz + b.z * xy - b.y * xz),
        .x = -b.w * yz,
        .y = b.w * xz,
    ...
    constexpr Quaternion Quaternion::dot(const Quaternion& b) const noexcept { return {
        .s = (b.s * s - b.xy * xy - b.xz * xz - b.yz * yz),
        .xy = (b.s * xy + b.xy * s),
        .xz = (b.s * xz + b.xz * s),
        .yz = (b.s * yz + b.yz * s)
    }; }
    constexpr Motor Quaternion::dot(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * s,
        .wx = b.wx * s,
        .wy = b.wy * s,
        .wz = b.wz * s,
    ...
    constexpr Motor Quaternion::dot(const Translator& b) const noexcept { return {
        .s = s,
        .wx = b.wx * s,
        .wy = b.wy * s,
        .wz = b.wz * s,
    ...
    constexpr Multivector Quaternion::dot(const Vector& b) const noexcept { return {
        .s = 0.0,
        .w = (b.x * yz + b.z * xy - b.y * xz),
        .x = 0.0,
        .y = 0.0,
    ...
    constexpr Multivector Quaternion::dot(const Point& b) const noexcept { return {
        .s = 0.0,
        .w = (b.x * yz + b.z * xy - b.y * xz),
        .x = -yz,
        .y = xz,
    ...
    constexpr PlaneIdeal Quaternion::dot(const PlaneIdeal& b) const noexcept { return {
        .x = (b.x * s + b.y * xy + b.z * xz),
        .y = (b.y * s + b.z * yz - b.x * xy),
        .z = (b.z * s - b.x * xz - b.y * yz)
    }; }
    constexpr Quaternion Quaternion::dot(const BivectorBulk& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .xy = b.xy * s,
        .xz = b.xz * s,
        .yz = b.yz * s
    }; }
    constexpr BivectorWeight Quaternion::dot(const BivectorWeight& b) const noexcept { return {
        .wx = b.wx * s,
        .wy = b.wy * s,
        .wz = b.wz * s
    }; }
    constexpr Motor Quaternion::dot(const PseudoScalar& b) const noexcept { return {
        .s = 0.0,
        .wx = -b.i * yz,
        .wy = b.i * xz,
        .wz = -b.i * xy,
    ...
    constexpr Multivector Quaternion::dot(const PointCenter& b) const noexcept { return {
        .s = 0.0,
        .w = 0.0,
        .x = -yz,
        .y = xz,
    ...
    constexpr Motor ProjectiveTranslator::dot(const Motor& b) const noexcept { return {
        .s = b.s * s,
        .wx = (b.s * wx + b.wx * s),
        .wy = (b.s * wy + b.wy * s),
        .wz = (b.s * wz + b.wz * s),
    ...
    constexpr Plane ProjectiveTranslator::dot(const Plane& b) const noexcept { return {
        .x = b.x * s,
        .y = b.y * s,
        .z = b.z * s,
        .w = (b.w * s + b.x * wx + b.y * wy + b.z * wz)
    }; }
    constexpr Bivector ProjectiveTranslator::dot(const Bivector& b) const noexcept { return {
        .wx = b.wx * s,
        .wy = b.wy * s,
        .wz = b.wz * s,
        .xy = b.xy * s,
    ...
    constexpr ProjectivePoint ProjectiveTranslator::dot(const ProjectivePoint& b) const noexcept { return {
        .x = b.x * s,
        .y = b.y * s,
        .z = b.z * s,
        .w = b.w * s
    }; }
    constexpr Motor ProjectiveTranslator::dot(const Quaternion& b) const noexcept { return {
        .s = b.s * s,
        .wx = b.s * wx,
        .wy = b.s * wy,
        .wz = b.s * wz,
    ...
    constexpr ProjectiveTranslator ProjectiveTranslator::dot(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * s,
        .wx = (b.s * wx + b.wx * s),
        .wy = (b.s * wy + b.wy * s),
        .wz = (b.s * wz + b.wz * s)
    }; }
    constexpr ProjectiveTranslator ProjectiveTranslator::dot(const Translator& b) const noexcept { return {
        .s = s,
        .wx = (wx + b.wx * s),
        .wy = (wy + b.wy * s),
        .wz = (wz + b.wz * s)
    }; }
    constexpr Vector ProjectiveTranslator::dot(const Vector& b) const noexcept { return {
        .x = b.x * s,
        .y = b.y * s,
        .z = b.z * s
    }; }
    constexpr ProjectivePoint ProjectiveTranslator::dot(const Point& b) const noexcept { return {
        .x = b.x * s,
        .y = b.y * s,
        .z = b.z * s,
        .w = s
    }; }
    constexpr Plane ProjectiveTranslator::dot(const PlaneIdeal& b) const noexcept { return {
        .x = b.x * s,
        .y = b.y * s,
        .z = b.z * s,
        .w = (b.x * wx + b.y * wy + b.z * wz)
    }; }
    constexpr BivectorBulk ProjectiveTranslator::dot(const BivectorBulk& b) const noexcept { return {
        .xy = b.xy * s,
        .xz = b.xz * s,
        .yz = b.yz * s
    }; }
    constexpr BivectorWeight ProjectiveTranslator::dot(const BivectorWeight& b) const noexcept { return {
        .wx = b.wx * s,
        .wy = b.wy * s,
        .wz = b.wz * s
    }; }
    constexpr PseudoScalar ProjectiveTranslator::dot(const PseudoScalar& b) const noexcept { return {
        .i = b.i * s
    }; }
    constexpr ProjectivePoint ProjectiveTranslator::dot(const PointCenter& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = s
    ...
    constexpr Motor Translator::dot(const Motor& b) const noexcept { return {
        .s = b.s,
        .wx = (b.wx + b.s * wx),
        .wy = (b.wy + b.s * wy),
        .wz = (b.wz + b.s * wz),
    ...
    constexpr Plane Translator::dot(const Plane& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = (b.w + b.x * wx + b.y * wy + b.z * wz)
    }; }
    constexpr Bivector Translator::dot(const Bivector& b) const noexcept { return {
        .wx = b.wx,
        .wy = b.wy,
        .wz = b.wz,
        .xy = b.xy,
    ...
    constexpr ProjectivePoint Translator::dot(const ProjectivePoint& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = b.w
    }; }
    constexpr Motor Translator::dot(const Quaternion& b) const noexcept { return {
        .s = b.s,
        .wx = b.s * wx,
        .wy = b.s * wy,
        .wz = b.s * wz,
    ...
    constexpr ProjectiveTranslator Translator::dot(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s,
        .wx = (b.wx + b.s * wx),
        .wy = (b.wy + b.s * wy),
        .wz = (b.wz + b.s * wz)
    }; }
    constexpr Translator Translator::dot(const Translator& b) const noexcept { return {
        .wx = (b.wx + wx),
        .wy = (b.wy + wy),
        .wz = (b.wz + wz)
    }; }
    constexpr Vector Translator::dot(const Vector& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z
    }; }
    constexpr Point Translator::dot(const Point& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z
    }; }
    constexpr Plane Translator::dot(const PlaneIdeal& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = (b.x * wx + b.y * wy + b.z * wz)
    }; }
    constexpr BivectorBulk Translator::dot(const BivectorBulk& b) const noexcept { return {
        .xy = b.xy,
        .xz = b.xz,
        .yz = b.yz
    }; }
    constexpr BivectorWeight Translator::dot(const BivectorWeight& b) const noexcept { return {
        .wx = b.wx,
        .wy = b.wy,
        .wz = b.wz
    }; }
    constexpr PseudoScalar Translator::dot(const PseudoScalar& b) const noexcept { return {
        .i = b.i
    }; }
    ...
    constexpr BivectorWeight Vector::dot(const Plane& b) const noexcept { return {
        .wx = (b.z * y - b.y * z),
        .wy = (b.x * z - b.z * x),
        .wz = (b.y * x - b.x * y)
    }; }
    constexpr Plane Vector::dot(const Bivector& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (b.xy * z + b.yz * x - b.xz * y)
    }; }
    constexpr Multivector Vector::dot(const Quaternion& b) const noexcept { return {
        .s = 0.0,
        .w = (b.xy * z + b.yz * x - b.xz * y),
        .x = 0.0,
        .y = 0.0,
    ...
    constexpr Vector Vector::dot(const ProjectiveTranslator& b) const noexcept { return {
        .x = b.s * x,
        .y = b.s * y,
        .z = b.s * z
    }; }
    constexpr Vector Vector::dot(const Translator& b) const noexcept { return {
        .x = x,
        .y = y,
        .z = z
    }; }
    constexpr BivectorWeight Vector::dot(const PlaneIdeal& b) const noexcept { return {
        .wx = (b.z * y - b.y * z),
        .wy = (b.x * z - b.z * x),
        .wz = (b.y * x - b.x * y)
    }; }
    constexpr Plane Vector::dot(const BivectorBulk& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (b.xy * z + b.yz * x - b.xz * y)
    ...
    constexpr Multivector Point::dot(const Motor& b) const noexcept { return {
        .s = 0.0,
        .w = (b.i + b.xy * z + b.yz * x - b.xz * y),
        .x = -b.yz,
        .y = b.xz,
    ...
    constexpr Bivector Point::dot(const Plane& b) const noexcept { return {
        .wx = (b.z * y - b.y * z),
        .wy = (b.x * z - b.z * x),
        .wz = (b.y * x - b.x * y),
        .xy = b.z,
    ...
    constexpr Plane Point::dot(const Bivector& b) const noexcept { return {
        .x = -b.yz,
        .y = b.xz,
        .z = -b.xy,
        .w = (b.xy * z + b.yz * x - b.xz * y)
    ...
    constexpr Multivector Point::dot(const Quaternion& b) const noexcept { return {
        .s = 0.0,
        .w = (b.xy * z + b.yz * x - b.xz * y),
        .x = -b.yz,
        .y = b.xz,
    ...
    constexpr ProjectivePoint Point::dot(const ProjectiveTranslator& b) const noexcept { return {
        .x = b.s * x,
        .y = b.s * y,
        .z = b.s * z,
        .w = b.s
    }; }
    constexpr Point Point::dot(const Translator& b) const noexcept { return {
        .x = x,
        .y = y,
        .z = z
    }; }
    constexpr double Point::dot(const Point& b) const noexcept { return -1.0; }
    constexpr Bivector Point::dot(const PlaneIdeal& b) const noexcept { return {
        .wx = (b.z * y - b.y * z),
        .wy = (b.x * z - b.z * x),
        .wz = (b.y * x - b.x * y),
        .xy = b.z,
    ...
    constexpr Plane Point::dot(const BivectorBulk& b) const noexcept { return {
        .x = -b.yz,
        .y = b.xz,
        .z = -b.xy,
        .w = (b.xy * z + b.yz * x - b.xz * y)
    }; }
    constexpr Plane Point::dot(const PseudoScalar& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = b.i
    ...
    constexpr Multivector PlaneIdeal::dot(const Motor& b) const noexcept { return {
        .s = 0.0,
        .w = (-b.wx * x - b.wy * y - b.wz * z),
        .x = (b.s * x - b.xy * y - b.xz * z),
        .y = (b.s * y + b.xy * x - b.yz * z),
    ...
    constexpr Plane PlaneIdeal::dot(const Bivector& b) const noexcept { return {
        .x = (-b.xy * y - b.xz * z),
        .y = (b.xy * x - b.yz * z),
        .z = (b.xz * x + b.yz * y),
        .w = (-b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr Bivector PlaneIdeal::dot(const ProjectivePoint& b) const noexcept { return {
        .wx = (b.y * z - b.z * y),
        .wy = (b.z * x - b.x * z),
        .wz = (b.x * y - b.y * x),
        .xy = b.w * z,
    ...
    constexpr PlaneIdeal PlaneIdeal::dot(const Quaternion& b) const noexcept { return {
        .x = (b.s * x - b.xy * y - b.xz * z),
        .y = (b.s * y + b.xy * x - b.yz * z),
        .z = (b.s * z + b.xz * x + b.yz * y)
    }; }
    constexpr Plane PlaneIdeal::dot(const ProjectiveTranslator& b) const noexcept { return {
        .x = b.s * x,
        .y = b.s * y,
        .z = b.s * z,
        .w = (-b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr Plane PlaneIdeal::dot(const Translator& b) const noexcept { return {
        .x = x,
        .y = y,
        .z = z,
        .w = (-b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr BivectorWeight PlaneIdeal::dot(const Vector& b) const noexcept { return {
        .wx = (b.y * z - b.z * y),
        .wy = (b.z * x - b.x * z),
        .wz = (b.x * y - b.y * x)
    }; }
    constexpr Bivector PlaneIdeal::dot(const Point& b) const noexcept { return {
        .wx = (b.y * z - b.z * y),
        .wy = (b.z * x - b.x * z),
        .wz = (b.x * y - b.y * x),
        .xy = z,
    ...
    constexpr PlaneIdeal PlaneIdeal::dot(const BivectorBulk& b) const noexcept { return {
        .x = (-b.xy * y - b.xz * z),
        .y = (b.xy * x - b.yz * z),
        .z = (b.xz * x + b.yz * y)
    }; }
    constexpr Plane PlaneIdeal::dot(const BivectorWeight& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (-b.wx * x - b.wy * y - b.wz * z)
    }; }
    constexpr Vector PlaneIdeal::dot(const PseudoScalar& b) const noexcept { return {
        .x = b.i * x,
        .y = b.i * y,
        .z = b.i * z
    }; }
    constexpr BivectorBulk PlaneIdeal::dot(const PointCenter& b) const noexcept { return {
        .xy = z,
        .xz = -y,
        .yz = x
    }; }

    constexpr Motor BivectorBulk::dot(const Motor& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .wx = -b.i * yz,
        .wy = b.i * xz,
        .wz = -b.i * xy,
    ...
    constexpr PlaneIdeal BivectorBulk::dot(const Plane& b) const noexcept { return {
        .x = (b.y * xy + b.z * xz),
        .y = (b.z * yz - b.x * xy),
        .z = (-b.x * xz - b.y * yz)
    }; }
    constexpr double BivectorBulk::dot(const Bivector& b) const noexcept { return (-b.xy * xy - b.xz * xz - b.yz * yz); }
    constexpr Plane BivectorBulk::dot(const ProjectivePoint& b) const noexcept { return {
        .x = -b.w * yz,
        .y = b.w * xz,
        .z = -b.w * xy,
        .w = (b.x * yz + b.z * xy - b.y * xz)
    }; }
    constexpr Quaternion BivectorBulk::dot(const Quaternion& b) const noexcept { return {
        .s = (-b.xy * xy - b.xz * xz - b.yz * yz),
        .xy = b.s * xy,
        .xz = b.s * xz,
        .yz = b.s * yz
    }; }
    constexpr BivectorBulk BivectorBulk::dot(const ProjectiveTranslator& b) const noexcept { return {
        .xy = b.s * xy,
        .xz = b.s * xz,
        .yz = b.s * yz
    }; }
    constexpr BivectorBulk BivectorBulk::dot(const Translator& b) const noexcept { return {
        .xy = xy,
        .xz = xz,
        .yz = yz
    }; }
    constexpr Plane BivectorBulk::dot(const Vector& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (b.x * yz + b.z * xy - b.y * xz)
    }; }
    constexpr Plane BivectorBulk::dot(const Point& b) const noexcept { return {
        .x = -yz,
        .y = xz,
        .z = -xy,
        .w = (b.x * yz + b.z * xy - b.y * xz)
    }; }
    constexpr PlaneIdeal BivectorBulk::dot(const PlaneIdeal& b) const noexcept { return {
        .x = (b.y * xy + b.z * xz),
        .y = (b.z * yz - b.x * xy),
        .z = (-b.x * xz - b.y * yz)
    }; }
    constexpr double BivectorBulk::dot(const BivectorBulk& b) const noexcept { return (-b.xy * xy - b.xz * xz - b.yz * yz); }
    constexpr BivectorWeight BivectorBulk::dot(const PseudoScalar& b) const noexcept { return {
        .wx = -b.i * yz,
        .wy = b.i * xz,
        .wz = -b.i * xy
    }; }
    constexpr PlaneIdeal BivectorBulk::dot(const PointCenter& b) const noexcept { return {
        .x = -yz,
        .y = xz,
        .z = -xy
    }; }

    constexpr BivectorWeight BivectorWeight::dot(const Motor& b) const noexcept { return {
        .wx = b.s * wx,
        .wy = b.s * wy,
        .wz = b.s * wz
    }; }
    constexpr Plane BivectorWeight::dot(const Plane& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (b.x * wx + b.y * wy + b.z * wz)
    }; }
    constexpr BivectorWeight BivectorWeight::dot(const Quaternion& b) const noexcept { return {
        .wx = b.s * wx,
        .wy = b.s * wy,
        .wz = b.s * wz
    }; }
    constexpr BivectorWeight BivectorWeight::dot(const ProjectiveTranslator& b) const noexcept { return {
        .wx = b.s * wx,
        .wy = b.s * wy,
        .wz = b.s * wz
    }; }
    constexpr BivectorWeight BivectorWeight::dot(const Translator& b) const noexcept { return {
        .wx = wx,
        .wy = wy,
        .wz = wz
    }; }
    constexpr Plane BivectorWeight::dot(const PlaneIdeal& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (b.x * wx + b.y * wy + b.z * wz)
    ...
    constexpr Motor PseudoScalar::dot(const Motor& b) const noexcept { return {
        .s = 0.0,
        .wx = -b.yz * i,
        .wy = b.xz * i,
        .wz = -b.xy * i,
    ...
    constexpr Vector PseudoScalar::dot(const Plane& b) const noexcept { return {
        .x = -b.x * i,
        .y = -b.y * i,
        .z = -b.z * i
    }; }
    constexpr BivectorWeight PseudoScalar::dot(const Bivector& b) const noexcept { return {
        .wx = -b.yz * i,
        .wy = b.xz * i,
        .wz = -b.xy * i
    }; }
    constexpr Plane PseudoScalar::dot(const ProjectivePoint& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = -b.w * i
    }; }
    constexpr Motor PseudoScalar::dot(const Quaternion& b) const noexcept { return {
        .s = 0.0,
        .wx = -b.yz * i,
        .wy = b.xz * i,
        .wz = -b.xy * i,
    ...
    constexpr PseudoScalar PseudoScalar::dot(const ProjectiveTranslator& b) const noexcept { return {
        .i = b.s * i
    }; }
    constexpr PseudoScalar PseudoScalar::dot(const Translator& b) const noexcept { return {
        .i = i
    }; }
    constexpr Plane PseudoScalar::dot(const Point& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = -i
    }; }
    constexpr Vector PseudoScalar::dot(const PlaneIdeal& b) const noexcept { return {
        .x = -b.x * i,
        .y = -b.y * i,
        .z = -b.z * i
    }; }
    constexpr BivectorWeight PseudoScalar::dot(const BivectorBulk& b) const noexcept { return {
        .wx = -b.yz * i,
        .wy = b.xz * i,
        .wz = -b.xy * i
    }; }
    constexpr Plane PseudoScalar::dot(const PointCenter& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = -i
    ...
    constexpr Multivector PointCenter::dot(const Motor& b) const noexcept { return {
        .s = 0.0,
        .w = b.i,
        .x = -b.yz,
        .y = b.xz,
    ...
    constexpr BivectorBulk PointCenter::dot(const Plane& b) const noexcept { return {
        .xy = b.z,
        .xz = -b.y,
        .yz = b.x
    }; }
    constexpr PlaneIdeal PointCenter::dot(const Bivector& b) const noexcept { return {
        .x = -b.yz,
        .y = b.xz,
        .z = -b.xy
    }; }
    constexpr double PointCenter::dot(const ProjectivePoint& b) const noexcept { return -b.w; }
    constexpr Multivector PointCenter::dot(const Quaternion& b) const noexcept { return {
        .s = 0.0,
        .w = 0.0,
        .x = -b.yz,
        .y = b.xz,
    ...
    constexpr ProjectivePoint PointCenter::dot(const ProjectiveTranslator& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = b.s
    ...
    constexpr BivectorBulk PointCenter::dot(const PlaneIdeal& b) const noexcept { return {
        .xy = b.z,
        .xz = -b.y,
        .yz = b.x
    }; }
    constexpr PlaneIdeal PointCenter::dot(const BivectorBulk& b) const noexcept { return {
        .x = -b.yz,
        .y = b.xz,
        .z = -b.xy
    }; }
    constexpr Plane PointCenter::dot(const PseudoScalar& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = b.i
...
namespace pga3d {
    constexpr Multivector Multivector::reverseSandwich(const Multivector& b) const noexcept { return {
        .s = (2.0 * (b.x * (s * x + xy * y + xyz * yz + xz * z) + b.y * (s * y + yz * z - x * xy - xyz * xz) + b.z * (s * z + xy * xyz - x * xz - y * yz)) + b.s * (s * s + x * x + xy * xy + xyz * xyz + xz * xz + y * y + yz * yz + z * z)),
        .w = (2.0 * (b.i * (x * yz + xy * z - s * xyz - xz * y) + b.s * (s * w + wxy * xy + wxz * xz + wyz * yz - i * xyz - wx * x - wy * y - wz * z) + b.x * (w * x + wxy * y + wxz * z + wyz * xyz - i * yz - s * wx - wy * xy - wz * xz) + b.y * (i * xz + w * y + wx * xy + wyz * z - s * wy - wxy * x - wxz * xyz - wz * yz) + b.z * (w * z + wx * xz + wxy * xyz + wy * yz - i * xy - s * wz - wxz * x - wyz * y)) + b.w * (s * s + xy * xy + xz * xz + yz * yz - x * x - xyz * xyz - y * y - z * z)),
        .x = (2.0 * (b.s * (s * x + xyz * yz - xy * y - xz * z) + b.y * (x * y + xyz * z - s * xy - xz * yz) + b.z * (x * z + xy * yz - s * xz - xyz * y)) + b.x * (s * s + x * x + xyz * xyz + yz * yz - xy * xy - xz * xz - y * y - z * z)),
        .y = (2.0 * (b.s * (s * y + x * xy - xyz * xz - yz * z) + b.x * (s * xy + x * y - xyz * z - xz * yz) + b.z * (x * xyz + y * z - s * yz - xy * xz)) + b.y * (s * s + xyz * xyz + xz * xz + y * y - x * x - xy * xy - yz * yz - z * z)),
        .z = (2.0 * (b.s * (s * z + x * xz + xy * xyz + y * yz) + b.x * (s * xz + x * z + xy * yz + xyz * y) + b.y * (s * yz + y * z - x * xyz - xy * xz)) + b.z * (s * s + xy * xy + xyz * xyz + z * z - x * x - xz * xz - y * y - yz * yz)),
        .wx = (2.0 * (s * (b.xy * wy + b.xyz * wyz + b.xz * wz - b.wyz * xyz - b.yz * i) + x * (b.wyz * yz + b.xy * wxy + b.xz * wxz + b.yz * wyz - b.xyz * i) + xy * (b.wxy * x + b.wz * yz + b.xy * wx + b.xyz * wxz - b.wxz * xyz - b.wy * s - b.wyz * z - b.xz * i - b.yz * wz) + xyz * (b.xy * wxz + b.xyz * wx - b.xz * wxy - b.yz * w) + xz * (b.wxy * xyz + b.wxz * x + b.xy * i + b.xz * wx + b.yz * wy - b.wy * yz - b.wz * s - b.xyz * wxy) + y * (b.wxy * s + b.wyz * xz + b.wz * xyz + b.xy * w + b.yz * wxz - b.wxz * yz - b.wy * x - b.xyz * wz - b.xz * wyz) + yz * (b.xy * wz + b.yz * wx - b.xyz * w - b.xz * wy) + z * (b.wxy * yz + b.wxz * s + b.xy * wyz + b.xyz * wy + b.xz * w - b.wy * xyz - b.wz * x - b.yz * wxy)) + b.wx * (s * s + y * y + yz * yz + z * z - x * x - xy * xy - xyz * xyz - xz * xz)),
        .wy = (2.0 * (s * (b.wxz * xyz + b.xz * i + b.yz * wz - b.xy * wx - b.xyz * wxz) + x * (b.wxz * yz + b.xyz * wz + b.xz * wyz - b.wx * y - b.wxy * s - b.wyz * xz - b.wz * xyz - b.xy * w - b.yz * wxz) + xy * (b.wx * s + b.wxy * y + b.xy * wy + b.xyz * wyz + b.xz * wz - b.wyz * xyz - b.wz * xz - b.yz * i) + xyz * (b.xy * wyz + b.xyz * wy + b.xz * w - b.yz * wxy) + xz * (b.wxz * y + b.xyz * w + b.xz * wy - b.xy * wz - b.yz * wx) + y * (b.xy * wxy + b.xz * wxz + b.yz * wyz - b.xyz * i) + yz * (b.wxy * xyz + b.wyz * y + b.xy * i + b.xz * wx + b.yz * wy - b.wx * xz - b.wz * s - b.xyz * wxy) + z * (b.wx * xyz + b.wxz * xy + b.wyz * s + b.xz * wxy + b.yz * w - b.wxy * xz - b.wz * y - b.xy * wxz - b.xyz * wx)) + b.wy * (s * s + x * x + xz * xz + z * z - xy * xy - xyz * xyz - y * y - yz * yz)),
        .wz = (2.0 * (s * (b.xyz * wxy - b.wxy * xyz - b.xy * i - b.xz * wx - b.yz * wy) + x * (b.wy * xyz + b.wyz * xy + b.yz * wxy - b.wx * z - b.wxy * yz - b.wxz * s - b.xy * wyz - b.xyz * wy - b.xz * w) + xy * (b.xy * wz + b.yz * wx - b.xyz * w - b.xz * wy) + xyz * (b.xyz * wz + b.xz * wyz - b.xy * w - b.yz * wxz) + xz * (b.wx * s + b.wxz * z + b.xy * wy + b.xyz * wyz + b.xz * wz - b.wy * xy - b.wyz * xyz - b.yz * i) + y * (b.wxy * xz + b.xy * wxz + b.xyz * wx - b.wx * xyz - b.wxz * xy - b.wy * z - b.wyz * s - b.xz * wxy - b.yz * w) + yz * (b.wx * xy + b.wxz * xyz + b.wy * s + b.wyz * z + b.xz * i + b.yz * wz - b.xy * wx - b.xyz * wxz) + z * (b.wxy * xy + b.xy * wxy + b.xz * wxz + b.yz * wyz - b.xyz * i)) + b.wz * (s * s + x * x + xy * xy + y * y - xyz * xyz - xz * xz - yz * yz - z * z)),
        .xy = (2.0 * (b.xyz * (s * z + x * xz + xy * xyz + y * yz) + b.xz * (x * xyz + xy * xz - s * yz - y * z) + b.yz * (s * xz + x * z + xy * yz + xyz * y)) + b.xy * (s * s + xy * xy + xyz * xyz + z * z - x * x - xz * xz - y * y - yz * yz)),
        .xz = (2.0 * (b.xy * (s * yz + xy * xz - x * xyz - y * z) + b.xyz * (xyz * xz + yz * z - s * y - x * xy) + b.yz * (xyz * z + xz * yz - s * xy - x * y)) + b.xz * (s * s + xyz * xyz + xz * xz + y * y - x * x - xy * xy - yz * yz - z * z)),
        .yz = (2.0 * (b.xy * (x * z + xy * yz - s * xz - xyz * y) + b.xyz * (s * x + xyz * yz - xy * y - xz * z) + b.xz * (s * xy + xz * yz - x * y - xyz * z)) + b.yz * (s * s + x * x + xyz * xyz + yz * yz - xy * xy - xz * xz - y * y - z * z)),
        .wxy = (2.0 * (s * (b.xy * w + b.yz * wxz - b.xyz * wz - b.xz * wyz) + x * (b.wz * yz + b.xy * wx + b.xyz * wxz - b.wx * xy - b.wxz * xyz - b.wy * s - b.wyz * z - b.xz * i - b.yz * wz) + xy * (b.xy * wxy + b.xz * wxz + b.yz * wyz - b.wz * z - b.xyz * i) + xyz * (b.wz * s + b.xyz * wxy - b.xy * i - b.xz * wx - b.yz * wy) + xz * (b.wx * xyz + b.wxz * xy + b.wy * z + b.wyz * s + b.xz * wxy + b.yz * w - b.xy * wxz - b.xyz * wx) + y * (b.wx * s + b.wxz * z + b.xy * wy + b.xyz * wyz + b.xz * wz - b.wy * xy - b.wyz * xyz - b.wz * xz - b.yz * i) + yz * (b.wy * xyz + b.wyz * xy + b.yz * wxy - b.wx * z - b.wxz * s - b.xy * wyz - b.xyz * wy - b.xz * w) + z * (b.xyz * w + b.xz * wy - b.xy * wz - b.yz * wx)) + b.wxy * (s * s + x * x + xy * xy + y * y - xyz * xyz - xz * xz - yz * yz - z * z)),
        .wxz = (2.0 * (s * (b.xy * wyz + b.xyz * wy + b.xz * w - b.wy * xyz - b.yz * wxy) + x * (b.wxy * xyz + b.wyz * y + b.xy * i + b.xz * wx + b.yz * wy - b.wx * xz - b.wy * yz - b.wz * s - b.xyz * wxy) + xy * (b.wxy * xz + b.wz * y + b.xy * wxz + b.xyz * wx - b.wx * xyz - b.wy * z - b.wyz * s - b.xz * wxy - b.yz * w) + xyz * (b.xy * wx + b.xyz * wxz - b.xz * i - b.yz * wz) + xz * (b.xy * wxy + b.xz * wxz + b.yz * wyz - b.wy * y - b.xyz * i) + y * (b.xy * wz + b.yz * wx - b.xyz * w - b.xz * wy) + yz * (b.wx * y + b.wxy * s + b.wyz * xz + b.wz * xyz + b.xy * w + b.yz * wxz - b.xyz * wz - b.xz * wyz) + z * (b.wx * s + b.wxy * y + b.xy * wy + b.xyz * wyz + b.xz * wz - b.wyz * xyz - b.wz * xz - b.yz * i)) + b.wxz * (s * s + x * x + xz * xz + z * z - xy * xy - xyz * xyz - y * y - yz * yz)),
        .wyz = (2.0 * (s * (b.wx * xyz + b.wxz * xy + b.wy * z + b.xz * wxy + b.yz * w - b.wxy * xz - b.wz * y - b.xy * wxz - b.xyz * wx) + x * (b.wxz * y + b.wy * xz + b.xyz * w + b.xz * wy - b.wx * yz - b.wxy * z - b.wz * xy - b.xy * wz - b.yz * wx) + xy * (b.xy * wyz + b.xyz * wy + b.xz * w - b.yz * wxy) + xyz * (b.wxy * y + b.wxz * z + b.xy * wy + b.xyz * wyz + b.xz * wz - b.wy * xy - b.wz * xz - b.yz * i) + xz * (b.xyz * wz + b.xz * wyz - b.wx * y - b.xy * w - b.yz * wxz) + y * (b.xy * i + b.xz * wx + b.yz * wy - b.xyz * wxy) + yz * (b.wxy * xy + b.wxz * xz + b.xy * wxy + b.xz * wxz + b.yz * wyz - b.wy * y - b.wz * z - b.xyz * i) + z * (b.wx * xy + b.xz * i + b.yz * wz - b.xy * wx - b.xyz * wxz)) + b.wyz * (s * s + y * y + yz * yz + z * z - x * x - xy * xy - xyz * xyz - xz * xz)),
        .xyz = (2.0 * (b.xy * (s * z + xy * xyz - x * xz - y * yz) + b.xz * (x * xy + xyz * xz - s * y - yz * z) + b.yz * (s * x + xy * y + xyz * yz + xz * z)) + b.xyz * (s * s + x * x + xy * xy + xyz * xyz + xz * xz + y * y + yz * yz + z * z)),
        .i = (2.0 * (b.s * (i * s + w * xyz + wxz * y + wy * xz - wx * yz - wxy * z - wyz * x - wz * xy) + b.w * (s * xyz + xz * y - x * yz - xy * z) + b.x * (i * x + w * yz + wxz * xy + wy * z - s * wyz - wx * xyz - wxy * xz - wz * y) + b.y * (i * y + s * wxz + wyz * xy + wz * x - w * xz - wx * z - wxy * yz - wy * xyz) + b.z * (i * z + w * xy + wx * y + wyz * xz - s * wxy - wxz * yz - wy * x - wz * xyz)) + b.i * (s * s + xy * xy + xz * xz + yz * yz - x * x - xyz * xyz - y * y - z * z))
    }; }

    constexpr Motor Motor::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * (s * s + xy * xy + xz * xz + yz * yz),
        .wx = (2.0 * (s * (b.xy * wy + b.xz * wz - b.wy * xy - b.wz * xz - b.yz * i) + xy * (b.xy * wx - b.xz * i - b.yz * wz) + xz * (b.xy * i + b.xz * wx + b.yz * wy) + yz * (b.wz * xy + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (s * (b.wx * xy + b.xz * i + b.yz * wz - b.wz * yz - b.xy * wx) + xy * (b.xy * wy + b.xz * wz - b.yz * i) + xz * (b.xz * wy - b.wx * yz - b.wz * xy - b.xy * wz - b.yz * wx) + yz * (b.xy * i + b.xz * wx + b.yz * wy)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (s * (b.wx * xz + b.wy * yz - b.xy * i - b.xz * wx - b.yz * wy) + xy * (b.wx * yz + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy) + xz * (b.xy * wy + b.xz * wz - b.yz * i) + yz * (b.xz * i + b.yz * wz - b.xy * wx)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)),
        .xy = (2.0 * (b.xz * (xy * xz - s * yz) + b.yz * (s * xz + xy * yz)) + b.xy * (s * s + xy * xy - xz * xz - yz * yz)),
        .xz = (2.0 * (b.xy * (s * yz + xy * xz) + b.yz * (xz * yz - s * xy)) + b.xz * (s * s + xz * xz - xy * xy - yz * yz)),
        .yz = (2.0 * (b.xy * (xy * yz - s * xz) + b.xz * (s * xy + xz * yz)) + b.yz * (s * s + yz * yz - xy * xy - xz * xz)),
        .i = (b.i * (s * s + xy * xy + xz * xz + yz * yz) + 2.0 * b.s * (i * s + wy * xz - wx * yz - wz * xy))
    }; }
    constexpr Plane Motor::reverseSandwich(const Plane& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)),
        .w = (2.0 * (b.x * (-i * yz - s * wx - wy * xy - wz * xz) + b.y * (i * xz + wx * xy - s * wy - wz * yz) + b.z * (wx * xz + wy * yz - i * xy - s * wz)) + b.w * (s * s + xy * xy + xz * xz + yz * yz))
    }; }
    constexpr Bivector Motor::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (2.0 * (s * (b.xy * wy + b.xz * wz - b.wy * xy - b.wz * xz - b.yz * i) + xy * (b.xy * wx - b.xz * i - b.yz * wz) + xz * (b.xy * i + b.xz * wx + b.yz * wy) + yz * (b.wz * xy + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (s * (b.wx * xy + b.xz * i + b.yz * wz - b.wz * yz - b.xy * wx) + xy * (b.xy * wy + b.xz * wz - b.yz * i) + xz * (b.xz * wy - b.wx * yz - b.wz * xy - b.xy * wz - b.yz * wx) + yz * (b.xy * i + b.xz * wx + b.yz * wy)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (s * (b.wx * xz + b.wy * yz - b.xy * i - b.xz * wx - b.yz * wy) + xy * (b.wx * yz + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy) + xz * (b.xy * wy + b.xz * wz - b.yz * i) + yz * (b.xz * i + b.yz * wz - b.xy * wx)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)),
        .xy = (2.0 * (b.xz * (xy * xz - s * yz) + b.yz * (s * xz + xy * yz)) + b.xy * (s * s + xy * xy - xz * xz - yz * yz)),
    ...
    constexpr ProjectivePoint Motor::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (2.0 * (b.w * (i * yz + s * wx - wy * xy - wz * xz) + b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.w * (s * wy + wx * xy - i * xz - wz * yz) + b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.w * (i * xy + s * wz + wx * xz + wy * yz) + b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)),
        .w = b.w * (s * s + xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Motor Motor::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * (s * s + xy * xy + xz * xz + yz * yz),
        .wx = 2.0 * (b.xy * (i * xz + s * wy + wx * xy + wz * yz) + b.xz * (s * wz + wx * xz - i * xy - wy * yz) + b.yz * (wx * yz + wy * xz - i * s - wz * xy)),
        .wy = 2.0 * (b.xy * (i * yz + wy * xy - s * wx - wz * xz) + b.xz * (i * s + wx * yz + wy * xz + wz * xy) + b.yz * (s * wz + wy * yz - i * xy - wx * xz)),
        .wz = 2.0 * (b.xy * (wy * xz + wz * xy - i * s - wx * yz) + b.xz * (i * yz + wz * xz - s * wx - wy * xy) + b.yz * (wx * xy + wz * yz - i * xz - s * wy)),
        .xy = (2.0 * (b.xz * (xy * xz - s * yz) + b.yz * (s * xz + xy * yz)) + b.xy * (s * s + xy * xy - xz * xz - yz * yz)),
        .xz = (2.0 * (b.xy * (s * yz + xy * xz) + b.yz * (xz * yz - s * xy)) + b.xz * (s * s + xz * xz - xy * xy - yz * yz)),
        .yz = (2.0 * (b.xy * (xy * yz - s * xz) + b.xz * (s * xy + xz * yz)) + b.yz * (s * s + yz * yz - xy * xy - xz * xz)),
        .i = 2.0 * b.s * (i * s + wy * xz - wx * yz - wz * xy)
    }; }
    constexpr Motor Motor::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * (s * s + xy * xy + xz * xz + yz * yz),
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)),
        .xy = 0.0,
        .xz = 0.0,
        .yz = 0.0,
        .i = 2.0 * b.s * (i * s + wy * xz - wx * yz - wz * xy)
    }; }
    constexpr Motor Motor::reverseSandwich(const Translator& b) const noexcept { return {
        .s = (s * s + xy * xy + xz * xz + yz * yz),
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)),
    ...
    constexpr Vector Motor::reverseSandwich(const Vector& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz))
    }; }
    constexpr ProjectivePoint Motor::reverseSandwich(const Point& b) const noexcept { return {
        .x = (2.0 * (i * yz + s * wx + xy * (-wy + b.z * yz - b.y * s) + xz * (-wz - b.y * yz - b.z * s)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (s * (wy + b.x * xy - b.z * yz) + wx * xy + xz * (-i - b.x * yz - b.z * xy) - wz * yz) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (s * (wz + b.x * xz + b.y * yz) + wx * xz + wy * yz + xy * (i + b.x * yz - b.y * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)),
        .w = (s * s + xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Plane Motor::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)),
        .w = 2.0 * (b.x * (-i * yz - s * wx - wy * xy - wz * xz) + b.y * (i * xz + wx * xy - s * wy - wz * yz) + b.z * (wx * xz + wy * yz - i * xy - s * wz))
    }; }
    constexpr Bivector Motor::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .wx = 2.0 * (b.xy * (i * xz + s * wy + wx * xy + wz * yz) + b.xz * (s * wz + wx * xz - i * xy - wy * yz) + b.yz * (wx * yz + wy * xz - i * s - wz * xy)),
        .wy = 2.0 * (b.xy * (i * yz + wy * xy - s * wx - wz * xz) + b.xz * (i * s + wx * yz + wy * xz + wz * xy) + b.yz * (s * wz + wy * yz - i * xy - wx * xz)),
        .wz = 2.0 * (b.xy * (wy * xz + wz * xy - i * s - wx * yz) + b.xz * (i * yz + wz * xz - s * wx - wy * xy) + b.yz * (wx * xy + wz * yz - i * xz - s * wy)),
        .xy = (2.0 * (b.xz * (xy * xz - s * yz) + b.yz * (s * xz + xy * yz)) + b.xy * (s * s + xy * xy - xz * xz - yz * yz)),
    ...
    constexpr BivectorWeight Motor::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz))
    }; }
    constexpr PseudoScalar Motor::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i * (s * s + xy * xy + xz * xz + yz * yz)
    }; }
    constexpr ProjectivePoint Motor::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 2.0 * (i * yz + s * wx - wy * xy - wz * xz),
    ...
    constexpr Motor Plane::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * (x * x + y * y + z * z),
        .wx = (2.0 * (w * (b.xy * y + b.xz * z) + x * (-b.wy * y - b.wz * z)) + b.wx * (y * y + z * z - x * x)),
        .wy = (2.0 * (x * (-b.wx * y - b.xy * w) + z * (b.yz * w - b.wz * y)) + b.wy * (x * x + z * z - y * y)),
        .wz = (2.0 * (x * (-b.wx * z - b.xz * w) + y * (-b.wy * z - b.yz * w)) + b.wz * (x * x + y * y - z * z)),
    ...
    constexpr Plane Plane::reverseSandwich(const Plane& b) const noexcept { return {
        .x = (b.x * (x * x - y * y - z * z) + 2.0 * x * (b.y * y + b.z * z)),
        .y = (b.y * (y * y - x * x - z * z) + 2.0 * y * (b.x * x + b.z * z)),
        .z = (b.z * (z * z - x * x - y * y) + 2.0 * z * (b.x * x + b.y * y)),
        .w = (b.w * (-x * x - y * y - z * z) + 2.0 * w * (b.x * x + b.y * y + b.z * z))
    }; }
    constexpr Bivector Plane::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (2.0 * (w * (b.xy * y + b.xz * z) + x * (-b.wy * y - b.wz * z)) + b.wx * (y * y + z * z - x * x)),
        .wy = (2.0 * (x * (-b.wx * y - b.xy * w) + z * (b.yz * w - b.wz * y)) + b.wy * (x * x + z * z - y * y)),
        .wz = (2.0 * (x * (-b.wx * z - b.xz * w) + y * (-b.wy * z - b.yz * w)) + b.wz * (x * x + y * y - z * z)),
        .xy = (b.xy * (z * z - x * x - y * y) + 2.0 * z * (b.yz * x - b.xz * y)),
    ...
    constexpr ProjectivePoint Plane::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (b.x * (y * y + z * z) + x * (2.0 * (-b.w * w - b.y * y - b.z * z) - b.x * x)),
        .y = (b.y * (x * x + z * z) + y * (2.0 * (-b.w * w - b.x * x - b.z * z) - b.y * y)),
        .z = (b.z * (x * x + y * y) + z * (2.0 * (-b.w * w - b.x * x - b.y * y) - b.z * z)),
        .w = b.w * (x * x + y * y + z * z)
    }; }
    constexpr Motor Plane::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * (x * x + y * y + z * z),
        .wx = 2.0 * w * (b.xy * y + b.xz * z),
        .wy = 2.0 * w * (b.yz * z - b.xy * x),
        .wz = 2.0 * w * (-b.xz * x - b.yz * y),
    ...
    constexpr ProjectiveTranslator Plane::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * (x * x + y * y + z * z),
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y))
    }; }
    constexpr ProjectiveTranslator Plane::reverseSandwich(const Translator& b) const noexcept { return {
        .s = (x * x + y * y + z * z),
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y))
    }; }
    constexpr Vector Plane::reverseSandwich(const Vector& b) const noexcept { return {
        .x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)),
        .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)),
        .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y))
    }; }
    constexpr ProjectivePoint Plane::reverseSandwich(const Point& b) const noexcept { return {
        .x = (b.x * (y * y + z * z) + x * (2.0 * (-w - b.y * y - b.z * z) - b.x * x)),
        .y = (b.y * (x * x + z * z) + y * (2.0 * (-w - b.x * x - b.z * z) - b.y * y)),
        .z = (b.z * (x * x + y * y) + z * (2.0 * (-w - b.x * x - b.y * y) - b.z * z)),
        .w = (x * x + y * y + z * z)
    }; }
    constexpr Plane Plane::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = (b.x * (x * x - y * y - z * z) + 2.0 * x * (b.y * y + b.z * z)),
        .y = (b.y * (y * y - x * x - z * z) + 2.0 * y * (b.x * x + b.z * z)),
        .z = (b.z * (z * z - x * x - y * y) + 2.0 * z * (b.x * x + b.y * y)),
        .w = 2.0 * w * (b.x * x + b.y * y + b.z * z)
    }; }
    constexpr Bivector Plane::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .wx = 2.0 * w * (b.xy * y + b.xz * z),
        .wy = 2.0 * w * (b.yz * z - b.xy * x),
        .wz = 2.0 * w * (-b.xz * x - b.yz * y),
        .xy = (b.xy * (z * z - x * x - y * y) + 2.0 * z * (b.yz * x - b.xz * y)),
    ...
    constexpr BivectorWeight Plane::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y))
    }; }
    constexpr PseudoScalar Plane::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i * (-x * x - y * y - z * z)
    }; }
    constexpr ProjectivePoint Plane::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = -2.0 * w * x,
        .y = -2.0 * w * y,
        .z = -2.0 * w * z,
        .w = (x * x + y * y + z * z)
    ...
    constexpr Motor Bivector::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * (xy * xy + xz * xz + yz * yz),
        .wx = (2.0 * (b.yz * (wy * xz - wz * xy) + wx * (b.xy * xy + b.xz * xz) + yz * (b.wz * xy + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy)) + b.wx * (yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.xz * (wx * yz + wz * xy) + wy * (b.xy * xy + b.yz * yz) + xz * (b.xz * wy - b.wx * yz - b.wz * xy - b.xy * wz - b.yz * wx)) + b.wy * (xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.xy * (wy * xz - wx * yz) + wz * (b.xz * xz + b.yz * yz) + xy * (b.wx * yz + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy)) + b.wz * (xy * xy - xz * xz - yz * yz)),
    ...
    constexpr Plane Bivector::reverseSandwich(const Plane& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)),
        .w = (2.0 * (b.x * (-wy * xy - wz * xz) + b.y * (wx * xy - wz * yz) + b.z * (wx * xz + wy * yz)) + b.w * (xy * xy + xz * xz + yz * yz))
    }; }
    constexpr Bivector Bivector::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (2.0 * (b.yz * (wy * xz - wz * xy) + wx * (b.xy * xy + b.xz * xz) + yz * (b.wz * xy + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy)) + b.wx * (yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.xz * (wx * yz + wz * xy) + wy * (b.xy * xy + b.yz * yz) + xz * (b.xz * wy - b.wx * yz - b.wz * xy - b.xy * wz - b.yz * wx)) + b.wy * (xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.xy * (wy * xz - wx * yz) + wz * (b.xz * xz + b.yz * yz) + xy * (b.wx * yz + b.xy * wz + b.yz * wx - b.wy * xz - b.xz * wy)) + b.wz * (xy * xy - xz * xz - yz * yz)),
        .xy = (b.xy * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.xz * xz + b.yz * yz)),
    ...
    constexpr ProjectivePoint Bivector::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (2.0 * (b.w * (-wy * xy - wz * xz) + yz * (b.z * xy - b.y * xz)) + b.x * (yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.w * (wx * xy - wz * yz) + xz * (-b.x * yz - b.z * xy)) + b.y * (xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.w * (wx * xz + wy * yz) + xy * (b.x * yz - b.y * xz)) + b.z * (xy * xy - xz * xz - yz * yz)),
        .w = b.w * (xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Motor Bivector::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * (xy * xy + xz * xz + yz * yz),
        .wx = 2.0 * (b.yz * (wy * xz - wz * xy) + wx * (b.xy * xy + b.xz * xz) + yz * (b.xy * wz + b.yz * wx - b.xz * wy)),
        .wy = 2.0 * (b.xz * (wx * yz + wz * xy) + wy * (b.xy * xy + b.yz * yz) + xz * (b.xz * wy - b.xy * wz - b.yz * wx)),
        .wz = 2.0 * (b.xy * (wy * xz + wz * xy - wx * yz) + b.xz * (wz * xz - wy * xy) + b.yz * (wx * xy + wz * yz)),
    ...
    constexpr Motor Bivector::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * (xy * xy + xz * xz + yz * yz),
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz)),
    ...
    constexpr Motor Bivector::reverseSandwich(const Translator& b) const noexcept { return {
        .s = (xy * xy + xz * xz + yz * yz),
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz)),
    ...
    constexpr Vector Bivector::reverseSandwich(const Vector& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz))
    }; }
    constexpr ProjectivePoint Bivector::reverseSandwich(const Point& b) const noexcept { return {
        .x = (2.0 * (xy * (-wy + b.z * yz) + xz * (-wz - b.y * yz)) + b.x * (yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (xy * (wx - b.z * xz) + yz * (-wz - b.x * xz)) + b.y * (xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (xz * (wx - b.y * xy) + yz * (wy + b.x * xy)) + b.z * (xy * xy - xz * xz - yz * yz)),
        .w = (xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Plane Bivector::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)),
        .w = 2.0 * (b.x * (-wy * xy - wz * xz) + b.y * (wx * xy - wz * yz) + b.z * (wx * xz + wy * yz))
    }; }
    constexpr Bivector Bivector::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .wx = 2.0 * (b.yz * (wy * xz - wz * xy) + wx * (b.xy * xy + b.xz * xz) + yz * (b.xy * wz + b.yz * wx - b.xz * wy)),
        .wy = 2.0 * (b.xz * (wx * yz + wz * xy) + wy * (b.xy * xy + b.yz * yz) + xz * (b.xz * wy - b.xy * wz - b.yz * wx)),
        .wz = 2.0 * (b.xy * (wy * xz + wz * xy - wx * yz) + b.xz * (wz * xz - wy * xy) + b.yz * (wx * xy + wz * yz)),
        .xy = (b.xy * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.xz * xz + b.yz * yz)),
    ...
    constexpr BivectorWeight Bivector::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz))
    }; }
    constexpr PseudoScalar Bivector::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i * (xy * xy + xz * xz + yz * yz)
    }; }
    constexpr ProjectivePoint Bivector::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 2.0 * (-wy * xy - wz * xz),
        .y = 2.0 * (wx * xy - wz * yz),
        .z = 2.0 * (wx * xz + wy * yz),
        .w = (xy * xy + xz * xz + yz * yz)
    ...
    constexpr Motor ProjectivePoint::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * w * w,
        .wx = w * (2.0 * (b.xy * y + b.xz * z) - b.wx * w),
        .wy = w * (2.0 * (b.yz * z - b.xy * x) - b.wy * w),
        .wz = w * (2.0 * (-b.xz * x - b.yz * y) - b.wz * w),
    ...
    constexpr Plane ProjectivePoint::reverseSandwich(const Plane& b) const noexcept { return {
        .x = b.x * w * w,
        .y = b.y * w * w,
        .z = b.z * w * w,
        .w = w * (2.0 * (-b.x * x - b.y * y - b.z * z) - b.w * w)
    }; }
    constexpr Bivector ProjectivePoint::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = w * (2.0 * (b.xy * y + b.xz * z) - b.wx * w),
        .wy = w * (2.0 * (b.yz * z - b.xy * x) - b.wy * w),
        .wz = w * (2.0 * (-b.xz * x - b.yz * y) - b.wz * w),
        .xy = b.xy * w * w,
    ...
    constexpr ProjectivePoint ProjectivePoint::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = w * (-b.x * w + 2.0 * b.w * x),
        .y = w * (-b.y * w + 2.0 * b.w * y),
        .z = w * (-b.z * w + 2.0 * b.w * z),
        .w = b.w * w * w
    }; }
    constexpr Motor ProjectivePoint::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * w * w,
        .wx = 2.0 * w * (b.xy * y + b.xz * z),
        .wy = 2.0 * w * (b.yz * z - b.xy * x),
        .wz = 2.0 * w * (-b.xz * x - b.yz * y),
    ...
    constexpr ProjectiveTranslator ProjectivePoint::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * w * w,
        .wx = -b.wx * w * w,
        .wy = -b.wy * w * w,
        .wz = -b.wz * w * w
    }; }
    constexpr ProjectiveTranslator ProjectivePoint::reverseSandwich(const Translator& b) const noexcept { return {
        .s = w * w,
        .wx = -b.wx * w * w,
        .wy = -b.wy * w * w,
        .wz = -b.wz * w * w
    }; }
    constexpr Vector ProjectivePoint::reverseSandwich(const Vector& b) const noexcept { return {
        .x = -b.x * w * w,
        .y = -b.y * w * w,
        .z = -b.z * w * w
    }; }
    constexpr ProjectivePoint ProjectivePoint::reverseSandwich(const Point& b) const noexcept { return {
        .x = w * (2.0 * x - b.x * w),
        .y = w * (2.0 * y - b.y * w),
        .z = w * (2.0 * z - b.z * w),
        .w = w * w
    }; }
    constexpr Plane ProjectivePoint::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = b.x * w * w,
        .y = b.y * w * w,
        .z = b.z * w * w,
        .w = 2.0 * w * (-b.x * x - b.y * y - b.z * z)
    }; }
    constexpr Bivector ProjectivePoint::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .wx = 2.0 * w * (b.xy * y + b.xz * z),
        .wy = 2.0 * w * (b.yz * z - b.xy * x),
        .wz = 2.0 * w * (-b.xz * x - b.yz * y),
        .xy = b.xy * w * w,
    ...
    constexpr BivectorWeight ProjectivePoint::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = -b.wx * w * w,
        .wy = -b.wy * w * w,
        .wz = -b.wz * w * w
    }; }
    constexpr PseudoScalar ProjectivePoint::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = -b.i * w * w
    }; }
    constexpr ProjectivePoint ProjectivePoint::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 2.0 * w * x,
        .y = 2.0 * w * y,
        .z = 2.0 * w * z,
        .w = w * w
    ...
    constexpr Motor Quaternion::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * (s * s + xy * xy + xz * xz + yz * yz),
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)),
    ...
    constexpr Plane Quaternion::reverseSandwich(const Plane& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)),
        .w = b.w * (s * s + xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Bivector Quaternion::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)),
        .xy = (2.0 * (b.xz * (xy * xz - s * yz) + b.yz * (s * xz + xy * yz)) + b.xy * (s * s + xy * xy - xz * xz - yz * yz)),
    ...
    constexpr ProjectivePoint Quaternion::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)),
        .w = b.w * (s * s + xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Quaternion Quaternion::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * (s * s + xy * xy + xz * xz + yz * yz),
        .xy = (2.0 * (b.xz * (xy * xz - s * yz) + b.yz * (s * xz + xy * yz)) + b.xy * (s * s + xy * xy - xz * xz - yz * yz)),
        .xz = (2.0 * (b.xy * (s * yz + xy * xz) + b.yz * (xz * yz - s * xy)) + b.xz * (s * s + xz * xz - xy * xy - yz * yz)),
        .yz = (2.0 * (b.xy * (xy * yz - s * xz) + b.xz * (s * xy + xz * yz)) + b.yz * (s * s + yz * yz - xy * xy - xz * xz))
    }; }
    constexpr ProjectiveTranslator Quaternion::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * (s * s + xy * xy + xz * xz + yz * yz),
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz))
    }; }
    constexpr ProjectiveTranslator Quaternion::reverseSandwich(const Translator& b) const noexcept { return {
        .s = (s * s + xy * xy + xz * xz + yz * yz),
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz))
    }; }
    constexpr Vector Quaternion::reverseSandwich(const Vector& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz))
    }; }
    constexpr ProjectivePoint Quaternion::reverseSandwich(const Point& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)),
        .w = (s * s + xy * xy + xz * xz + yz * yz)
    }; }
    constexpr PlaneIdeal Quaternion::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)),
        .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)),
        .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz))
    }; }
    constexpr BivectorBulk Quaternion::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .xy = (2.0 * (b.xz * (xy * xz - s * yz) + b.yz * (s * xz + xy * yz)) + b.xy * (s * s + xy * xy - xz * xz - yz * yz)),
        .xz = (2.0 * (b.xy * (s * yz + xy * xz) + b.yz * (xz * yz - s * xy)) + b.xz * (s * s + xz * xz - xy * xy - yz * yz)),
        .yz = (2.0 * (b.xy * (xy * yz - s * xz) + b.xz * (s * xy + xz * yz)) + b.yz * (s * s + yz * yz - xy * xy - xz * xz))
    }; }
    constexpr BivectorWeight Quaternion::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)),
        .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)),
        .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz))
    }; }
    constexpr PseudoScalar Quaternion::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i * (s * s + xy * xy + xz * xz + yz * yz)
    }; }
    constexpr ProjectivePoint Quaternion::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (s * s + xy * xy + xz * xz + yz * yz)
    ...
    constexpr Motor ProjectiveTranslator::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * s * s,
        .wx = s * (2.0 * (b.xy * wy + b.xz * wz) + b.wx * s),
        .wy = s * (2.0 * (b.yz * wz - b.xy * wx) + b.wy * s),
        .wz = s * (2.0 * (-b.xz * wx - b.yz * wy) + b.wz * s),
        .xy = b.xy * s * s,
        .xz = b.xz * s * s,
        .yz = b.yz * s * s,
    ...
    constexpr Plane ProjectiveTranslator::reverseSandwich(const Plane& b) const noexcept { return {
        .x = b.x * s * s,
        .y = b.y * s * s,
        .z = b.z * s * s,
        .w = s * (2.0 * (-b.x * wx - b.y * wy - b.z * wz) + b.w * s)
    }; }
    constexpr Bivector ProjectiveTranslator::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = s * (2.0 * (b.xy * wy + b.xz * wz) + b.wx * s),
        .wy = s * (2.0 * (b.yz * wz - b.xy * wx) + b.wy * s),
        .wz = s * (2.0 * (-b.xz * wx - b.yz * wy) + b.wz * s),
        .xy = b.xy * s * s,
    ...
    constexpr ProjectivePoint ProjectiveTranslator::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = s * (b.x * s + 2.0 * b.w * wx),
        .y = s * (b.y * s + 2.0 * b.w * wy),
        .z = s * (b.z * s + 2.0 * b.w * wz),
        .w = b.w * s * s
    }; }
    constexpr Motor ProjectiveTranslator::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * s * s,
        .wx = 2.0 * s * (b.xy * wy + b.xz * wz),
        .wy = 2.0 * s * (b.yz * wz - b.xy * wx),
        .wz = 2.0 * s * (-b.xz * wx - b.yz * wy),
        .xy = b.xy * s * s,
        .xz = b.xz * s * s,
        .yz = b.yz * s * s,
    ...
    constexpr ProjectiveTranslator ProjectiveTranslator::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * s * s,
        .wx = b.wx * s * s,
        .wy = b.wy * s * s,
        .wz = b.wz * s * s
    }; }
    constexpr ProjectiveTranslator ProjectiveTranslator::reverseSandwich(const Translator& b) const noexcept { return {
        .s = s * s,
        .wx = b.wx * s * s,
        .wy = b.wy * s * s,
        .wz = b.wz * s * s
    }; }
    constexpr Vector ProjectiveTranslator::reverseSandwich(const Vector& b) const noexcept { return {
        .x = b.x * s * s,
        .y = b.y * s * s,
        .z = b.z * s * s
    }; }
    constexpr ProjectivePoint ProjectiveTranslator::reverseSandwich(const Point& b) const noexcept { return {
        .x = s * (2.0 * wx + b.x * s),
        .y = s * (2.0 * wy + b.y * s),
        .z = s * (2.0 * wz + b.z * s),
        .w = s * s
    }; }
    constexpr Plane ProjectiveTranslator::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = b.x * s * s,
        .y = b.y * s * s,
        .z = b.z * s * s,
        .w = 2.0 * s * (-b.x * wx - b.y * wy - b.z * wz)
    }; }
    constexpr Bivector ProjectiveTranslator::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .wx = 2.0 * s * (b.xy * wy + b.xz * wz),
        .wy = 2.0 * s * (b.yz * wz - b.xy * wx),
        .wz = 2.0 * s * (-b.xz * wx - b.yz * wy),
        .xy = b.xy * s * s,
    ...
    constexpr BivectorWeight ProjectiveTranslator::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = b.wx * s * s,
        .wy = b.wy * s * s,
        .wz = b.wz * s * s
    }; }
    constexpr PseudoScalar ProjectiveTranslator::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i * s * s
    }; }
    constexpr ProjectivePoint ProjectiveTranslator::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 2.0 * s * wx,
        .y = 2.0 * s * wy,
        .z = 2.0 * s * wz,
        .w = s * s
    ...
    constexpr Motor Translator::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s,
        .wx = (b.wx + 2.0 * b.xy * wy + 2.0 * b.xz * wz),
        .wy = (b.wy - 2.0 * b.xy * wx + 2.0 * b.yz * wz),
        .wz = (b.wz - 2.0 * b.xz * wx - 2.0 * b.yz * wy),
        .xy = b.xy,
        .xz = b.xz,
        .yz = b.yz,
    ...
    constexpr Plane Translator::reverseSandwich(const Plane& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = (b.w - 2.0 * b.x * wx - 2.0 * b.y * wy - 2.0 * b.z * wz)
    }; }
    constexpr Bivector Translator::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (b.wx + 2.0 * b.xy * wy + 2.0 * b.xz * wz),
        .wy = (b.wy - 2.0 * b.xy * wx + 2.0 * b.yz * wz),
        .wz = (b.wz - 2.0 * b.xz * wx - 2.0 * b.yz * wy),
        .xy = b.xy,
    ...
    constexpr ProjectivePoint Translator::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (b.x + 2.0 * b.w * wx),
        .y = (b.y + 2.0 * b.w * wy),
        .z = (b.z + 2.0 * b.w * wz),
        .w = b.w
    }; }
    constexpr Motor Translator::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s,
        .wx = 2.0 * (b.xy * wy + b.xz * wz),
        .wy = 2.0 * (b.yz * wz - b.xy * wx),
        .wz = 2.0 * (-b.xz * wx - b.yz * wy),
        .xy = b.xy,
        .xz = b.xz,
        .yz = b.yz,
    ...
    constexpr ProjectiveTranslator Translator::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s,
        .wx = b.wx,
        .wy = b.wy,
        .wz = b.wz
    }; }
    constexpr Translator Translator::reverseSandwich(const Translator& b) const noexcept { return {
        .wx = b.wx,
        .wy = b.wy,
        .wz = b.wz
    }; }
    constexpr Vector Translator::reverseSandwich(const Vector& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z
    }; }
    constexpr Point Translator::reverseSandwich(const Point& b) const noexcept { return {
        .x = (b.x + 2.0 * wx),
        .y = (b.y + 2.0 * wy),
        .z = (b.z + 2.0 * wz)
    }; }
    constexpr Plane Translator::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = 2.0 * (-b.x * wx - b.y * wy - b.z * wz)
    }; }
    constexpr Bivector Translator::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .wx = 2.0 * (b.xy * wy + b.xz * wz),
        .wy = 2.0 * (b.yz * wz - b.xy * wx),
        .wz = 2.0 * (-b.xz * wx - b.yz * wy),
        .xy = b.xy,
    ...
    constexpr BivectorWeight Translator::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = b.wx,
        .wy = b.wy,
        .wz = b.wz
    }; }
    constexpr PseudoScalar Translator::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i
    }; }
    constexpr Point Translator::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 2.0 * wx,
        .y = 2.0 * wy,
        .z = 2.0 * wz
    }; }

    constexpr Motor Point::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s,
        .wx = (-b.wx + 2.0 * (b.xy * y + b.xz * z)),
        .wy = (-b.wy + 2.0 * (b.yz * z - b.xy * x)),
        .wz = (-b.wz + 2.0 * (-b.xz * x - b.yz * y)),
    ...
    constexpr Plane Point::reverseSandwich(const Plane& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = (-b.w + 2.0 * (-b.x * x - b.y * y - b.z * z))
    }; }
    constexpr Bivector Point::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (-b.wx + 2.0 * (b.xy * y + b.xz * z)),
        .wy = (-b.wy + 2.0 * (b.yz * z - b.xy * x)),
        .wz = (-b.wz + 2.0 * (-b.xz * x - b.yz * y)),
        .xy = b.xy,
    ...
    constexpr ProjectivePoint Point::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (-b.x + 2.0 * b.w * x),
        .y = (-b.y + 2.0 * b.w * y),
        .z = (-b.z + 2.0 * b.w * z),
        .w = b.w
    }; }
    constexpr Motor Point::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s,
        .wx = 2.0 * (b.xy * y + b.xz * z),
        .wy = 2.0 * (b.yz * z - b.xy * x),
        .wz = 2.0 * (-b.xz * x - b.yz * y),
    ...
    constexpr ProjectiveTranslator Point::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s,
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz
    }; }
    constexpr Translator Point::reverseSandwich(const Translator& b) const noexcept { return {
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz
    }; }
    constexpr Vector Point::reverseSandwich(const Vector& b) const noexcept { return {
        .x = -b.x,
        .y = -b.y,
        .z = -b.z
    }; }
    constexpr Point Point::reverseSandwich(const Point& b) const noexcept { return {
        .x = (-b.x + 2.0 * x),
        .y = (-b.y + 2.0 * y),
        .z = (-b.z + 2.0 * z)
    }; }
    constexpr Plane Point::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = 2.0 * (-b.x * x - b.y * y - b.z * z)
    }; }
    constexpr Bivector Point::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .wx = 2.0 * (b.xy * y + b.xz * z),
        .wy = 2.0 * (b.yz * z - b.xy * x),
        .wz = 2.0 * (-b.xz * x - b.yz * y),
        .xy = b.xy,
    ...
    constexpr BivectorWeight Point::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz
    }; }
    constexpr PseudoScalar Point::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = -b.i
    }; }
    constexpr Point Point::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 2.0 * x,
        .y = 2.0 * y,
        .z = 2.0 * z
    }; }

    constexpr Motor PlaneIdeal::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * (x * x + y * y + z * z),
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y)),
    ...
    constexpr Plane PlaneIdeal::reverseSandwich(const Plane& b) const noexcept { return {
        .x = (b.x * (x * x - y * y - z * z) + 2.0 * x * (b.y * y + b.z * z)),
        .y = (b.y * (y * y - x * x - z * z) + 2.0 * y * (b.x * x + b.z * z)),
        .z = (b.z * (z * z - x * x - y * y) + 2.0 * z * (b.x * x + b.y * y)),
        .w = b.w * (-x * x - y * y - z * z)
    }; }
    constexpr Bivector PlaneIdeal::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y)),
        .xy = (b.xy * (z * z - x * x - y * y) + 2.0 * z * (b.yz * x - b.xz * y)),
    ...
    constexpr ProjectivePoint PlaneIdeal::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)),
        .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)),
        .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y)),
        .w = b.w * (x * x + y * y + z * z)
    }; }
    constexpr Quaternion PlaneIdeal::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * (x * x + y * y + z * z),
        .xy = (b.xy * (z * z - x * x - y * y) + 2.0 * z * (b.yz * x - b.xz * y)),
        .xz = (b.xz * (y * y - x * x - z * z) + 2.0 * y * (-b.xy * z - b.yz * x)),
        .yz = (b.yz * (x * x - y * y - z * z) + 2.0 * x * (b.xy * z - b.xz * y))
    }; }
    constexpr ProjectiveTranslator PlaneIdeal::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * (x * x + y * y + z * z),
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y))
    }; }
    constexpr ProjectiveTranslator PlaneIdeal::reverseSandwich(const Translator& b) const noexcept { return {
        .s = (x * x + y * y + z * z),
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y))
    }; }
    constexpr Vector PlaneIdeal::reverseSandwich(const Vector& b) const noexcept { return {
        .x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)),
        .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)),
        .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y))
    }; }
    constexpr ProjectivePoint PlaneIdeal::reverseSandwich(const Point& b) const noexcept { return {
        .x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)),
        .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)),
        .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y)),
        .w = (x * x + y * y + z * z)
    }; }
    constexpr PlaneIdeal PlaneIdeal::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = (b.x * (x * x - y * y - z * z) + 2.0 * x * (b.y * y + b.z * z)),
        .y = (b.y * (y * y - x * x - z * z) + 2.0 * y * (b.x * x + b.z * z)),
        .z = (b.z * (z * z - x * x - y * y) + 2.0 * z * (b.x * x + b.y * y))
    }; }
    constexpr BivectorBulk PlaneIdeal::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .xy = (b.xy * (z * z - x * x - y * y) + 2.0 * z * (b.yz * x - b.xz * y)),
        .xz = (b.xz * (y * y - x * x - z * z) + 2.0 * y * (-b.xy * z - b.yz * x)),
        .yz = (b.yz * (x * x - y * y - z * z) + 2.0 * x * (b.xy * z - b.xz * y))
    }; }
    constexpr BivectorWeight PlaneIdeal::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)),
        .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)),
        .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y))
    }; }
    constexpr PseudoScalar PlaneIdeal::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i * (-x * x - y * y - z * z)
    }; }
    constexpr ProjectivePoint PlaneIdeal::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (x * x + y * y + z * z)
    ...
    constexpr Motor BivectorBulk::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s * (xy * xy + xz * xz + yz * yz),
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz)),
    ...
    constexpr Plane BivectorBulk::reverseSandwich(const Plane& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)),
        .w = b.w * (xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Bivector BivectorBulk::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz)),
        .xy = (b.xy * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.xz * xz + b.yz * yz)),
    ...
    constexpr ProjectivePoint BivectorBulk::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)),
        .w = b.w * (xy * xy + xz * xz + yz * yz)
    }; }
    constexpr Quaternion BivectorBulk::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s * (xy * xy + xz * xz + yz * yz),
        .xy = (b.xy * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.xz * xz + b.yz * yz)),
        .xz = (b.xz * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (b.xy * xy + b.yz * yz)),
        .yz = (b.yz * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.xy * xy + b.xz * xz))
    }; }
    constexpr ProjectiveTranslator BivectorBulk::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s * (xy * xy + xz * xz + yz * yz),
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz))
    }; }
    constexpr ProjectiveTranslator BivectorBulk::reverseSandwich(const Translator& b) const noexcept { return {
        .s = (xy * xy + xz * xz + yz * yz),
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz))
    }; }
    constexpr Vector BivectorBulk::reverseSandwich(const Vector& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz))
    }; }
    constexpr ProjectivePoint BivectorBulk::reverseSandwich(const Point& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)),
        .w = (xy * xy + xz * xz + yz * yz)
    }; }
    constexpr PlaneIdeal BivectorBulk::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)),
        .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)),
        .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz))
    }; }
    constexpr BivectorBulk BivectorBulk::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .xy = (b.xy * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.xz * xz + b.yz * yz)),
        .xz = (b.xz * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (b.xy * xy + b.yz * yz)),
        .yz = (b.yz * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.xy * xy + b.xz * xz))
    }; }
    constexpr BivectorWeight BivectorBulk::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)),
        .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)),
        .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz))
    }; }
    constexpr PseudoScalar BivectorBulk::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = b.i * (xy * xy + xz * xz + yz * yz)
    }; }
    constexpr ProjectivePoint BivectorBulk::reverseSandwich(const PointCenter& b) const noexcept { return {
        .x = 0.0,
        .y = 0.0,
        .z = 0.0,
        .w = (xy * xy + xz * xz + yz * yz)
    ...
    constexpr Motor PointCenter::reverseSandwich(const Motor& b) const noexcept { return {
        .s = b.s,
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz,
    ...
    constexpr Plane PointCenter::reverseSandwich(const Plane& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z,
        .w = -b.w
    }; }
    constexpr Bivector PointCenter::reverseSandwich(const Bivector& b) const noexcept { return {
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz,
        .xy = b.xy,
    ...
    constexpr ProjectivePoint PointCenter::reverseSandwich(const ProjectivePoint& b) const noexcept { return {
        .x = -b.x,
        .y = -b.y,
        .z = -b.z,
        .w = b.w
    }; }
    constexpr Quaternion PointCenter::reverseSandwich(const Quaternion& b) const noexcept { return {
        .s = b.s,
        .xy = b.xy,
        .xz = b.xz,
        .yz = b.yz
    }; }
    constexpr ProjectiveTranslator PointCenter::reverseSandwich(const ProjectiveTranslator& b) const noexcept { return {
        .s = b.s,
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz
    }; }
    constexpr Translator PointCenter::reverseSandwich(const Translator& b) const noexcept { return {
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz
    }; }
    constexpr Vector PointCenter::reverseSandwich(const Vector& b) const noexcept { return {
        .x = -b.x,
        .y = -b.y,
        .z = -b.z
    }; }
    constexpr Point PointCenter::reverseSandwich(const Point& b) const noexcept { return {
        .x = -b.x,
        .y = -b.y,
        .z = -b.z
    }; }
    constexpr PlaneIdeal PointCenter::reverseSandwich(const PlaneIdeal& b) const noexcept { return {
        .x = b.x,
        .y = b.y,
        .z = b.z
    }; }
    constexpr BivectorBulk PointCenter::reverseSandwich(const BivectorBulk& b) const noexcept { return {
        .xy = b.xy,
        .xz = b.xz,
        .yz = b.yz
    }; }
    constexpr BivectorWeight PointCenter::reverseSandwich(const BivectorWeight& b) const noexcept { return {
        .wx = -b.wx,
        .wy = -b.wy,
        .wz = -b.wz
    }; }
    constexpr PseudoScalar PointCenter::reverseSandwich(const PseudoScalar& b) const noexcept { return {
        .i = -b.i
    }; }
