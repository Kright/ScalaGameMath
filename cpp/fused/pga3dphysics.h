...
namespace pga3d {
    ...
    constexpr ProjectivePoint Motor::sandwich(const ProjectivePoint& b) const noexcept { return {.x = (2.0 * (b.w * (-i * yz - s * wx - wy * xy - wz * xz) + b.y * (s * xy - xz * yz) + b.z * (s * xz + xy * yz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.w * (i * xz + wx * xy - s * wy - wz * yz) + b.x * (-s * xy - xz * yz) + b.z * (s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.w * (wx * xz + wy * yz - i * xy - s * wz) + b.x * (xy * yz - s * xz) + b.y * (-s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = b.w * (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector Motor::sandwich(const Vector& b) const noexcept { return {.x = (2.0 * (b.y * (s * xy - xz * yz) + b.z * (s * xz + xy * yz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (-s * xy - xz * yz) + b.z * (s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (xy * yz - s * xz) + b.y * (-s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz))}; }
    constexpr ProjectivePoint Motor::sandwich(const Point& b) const noexcept { return {.x = (2.0 * (s * (-wx + b.y * xy + b.z * xz) + yz * (-i + b.z * xy - b.y * xz) - wy * xy - wz * xz) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (s * (-wy + b.z * yz - b.x * xy) + wx * xy + xz * (i - b.x * yz - b.z * xy) - wz * yz) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (s * (-wz - b.x * xz - b.y * yz) + wx * xz + wy * yz + xy * (-i + b.x * yz - b.y * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint Motor::sandwich(const PointCenter& b) const noexcept { return {.x = 2.0 * (-i * yz - s * wx - wy * xy - wz * xz), .y = 2.0 * (i * xz + wx * xy - s * wy - wz * yz), .z = 2.0 * (wx * xz + wy * yz - i * xy - s * wz), .w = (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint Plane::sandwich(const ProjectivePoint& b) const noexcept { return {.x = (b.x * (y * y + z * z) + x * (2.0 * (-b.w * w - b.y * y - b.z * z) - b.x * x)), .y = (b.y * (x * x + z * z) + y * (2.0 * (-b.w * w - b.x * x - b.z * z) - b.y * y)), .z = (b.z * (x * x + y * y) + z * (2.0 * (-b.w * w - b.x * x - b.y * y) - b.z * z)), .w = b.w * (x * x + y * y + z * z)}; }
    ...
    constexpr Vector Plane::sandwich(const Vector& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y))}; }
    ...
    constexpr ProjectivePoint Bivector::sandwich(const ProjectivePoint& b) const noexcept { return {.x = (2.0 * (b.w * (-wy * xy - wz * xz) + yz * (b.z * xy - b.y * xz)) + b.x * (yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.w * (wx * xy - wz * yz) + xz * (-b.x * yz - b.z * xy)) + b.y * (xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.w * (wx * xz + wy * yz) + xy * (b.x * yz - b.y * xz)) + b.z * (xy * xy - xz * xz - yz * yz)), .w = b.w * (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector Bivector::sandwich(const Vector& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz))}; }
    constexpr ProjectivePoint Bivector::sandwich(const Point& b) const noexcept { return {.x = (2.0 * (xy * (-wy + b.z * yz) + xz * (-wz - b.y * yz)) + b.x * (yz * yz - xy * xy - xz * xz)), .y = (2.0 * (xy * (wx - b.z * xz) + yz * (-wz - b.x * xz)) + b.y * (xz * xz - xy * xy - yz * yz)), .z = (2.0 * (xz * (wx - b.y * xy) + yz * (wy + b.x * xy)) + b.z * (xy * xy - xz * xz - yz * yz)), .w = (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint Bivector::sandwich(const PointCenter& b) const noexcept { return {.x = 2.0 * (-wy * xy - wz * xz), .y = 2.0 * (wx * xy - wz * yz), .z = 2.0 * (wx * xz + wy * yz), .w = (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint ProjectivePoint::sandwich(const ProjectivePoint& b) const noexcept { return {.x = w * (-b.x * w + 2.0 * b.w * x), .y = w * (-b.y * w + 2.0 * b.w * y), .z = w * (-b.z * w + 2.0 * b.w * z), .w = b.w * w * w}; }
    ...
    constexpr ProjectivePoint ProjectivePoint::sandwich(const Point& b) const noexcept { return {.x = w * (2.0 * x - b.x * w), .y = w * (2.0 * y - b.y * w), .z = w * (2.0 * z - b.z * w), .w = w * w}; }
    ...
    constexpr ProjectivePoint Quaternion::sandwich(const ProjectivePoint& b) const noexcept { return {.x = (2.0 * (b.y * (s * xy - xz * yz) + b.z * (s * xz + xy * yz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (-s * xy - xz * yz) + b.z * (s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (xy * yz - s * xz) + b.y * (-s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = b.w * (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector Quaternion::sandwich(const Vector& b) const noexcept { return {.x = (2.0 * (b.y * (s * xy - xz * yz) + b.z * (s * xz + xy * yz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (-s * xy - xz * yz) + b.z * (s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (xy * yz - s * xz) + b.y * (-s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz))}; }
    constexpr ProjectivePoint Quaternion::sandwich(const Point& b) const noexcept { return {.x = (2.0 * (b.y * (s * xy - xz * yz) + b.z * (s * xz + xy * yz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (-s * xy - xz * yz) + b.z * (s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (xy * yz - s * xz) + b.y * (-s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint ProjectiveTranslator::sandwich(const ProjectivePoint& b) const noexcept { return {.x = s * (b.x * s - 2.0 * b.w * wx), .y = s * (b.y * s - 2.0 * b.w * wy), .z = s * (b.z * s - 2.0 * b.w * wz), .w = b.w * s * s}; }
    ...
    constexpr ProjectivePoint ProjectiveTranslator::sandwich(const Point& b) const noexcept { return {.x = s * (b.x * s - 2.0 * wx), .y = s * (b.y * s - 2.0 * wy), .z = s * (b.z * s - 2.0 * wz), .w = s * s}; }
    ...
    constexpr ProjectivePoint PlaneIdeal::sandwich(const ProjectivePoint& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y)), .w = b.w * (x * x + y * y + z * z)}; }
    ...
    constexpr Vector PlaneIdeal::sandwich(const Vector& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y))}; }
    constexpr ProjectivePoint PlaneIdeal::sandwich(const Point& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y)), .w = (x * x + y * y + z * z)}; }
    ...
    constexpr ProjectivePoint BivectorBulk::sandwich(const ProjectivePoint& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)), .w = b.w * (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector BivectorBulk::sandwich(const Vector& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz))}; }
    constexpr ProjectivePoint BivectorBulk::sandwich(const Point& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)), .w = (xy * xy + xz * xz + yz * yz)}; }
...
namespace pga3d {
    ...
    constexpr ProjectivePoint Motor::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = (2.0 * (b.w * (i * yz + s * wx - wy * xy - wz * xz) + b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.w * (s * wy + wx * xy - i * xz - wz * yz) + b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.w * (i * xy + s * wz + wx * xz + wy * yz) + b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = b.w * (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector Motor::reverseSandwich(const Vector& b) const noexcept { return {.x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz))}; }
    constexpr ProjectivePoint Motor::reverseSandwich(const Point& b) const noexcept { return {.x = (2.0 * (i * yz + s * wx + xy * (-wy + b.z * yz - b.y * s) + xz * (-wz - b.y * yz - b.z * s)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (s * (wy + b.x * xy - b.z * yz) + wx * xy + xz * (-i - b.x * yz - b.z * xy) - wz * yz) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (s * (wz + b.x * xz + b.y * yz) + wx * xz + wy * yz + xy * (i + b.x * yz - b.y * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint Motor::reverseSandwich(const PointCenter& b) const noexcept { return {.x = 2.0 * (i * yz + s * wx - wy * xy - wz * xz), .y = 2.0 * (s * wy + wx * xy - i * xz - wz * yz), .z = 2.0 * (i * xy + s * wz + wx * xz + wy * yz), .w = (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint Plane::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = (b.x * (y * y + z * z) + x * (2.0 * (-b.w * w - b.y * y - b.z * z) - b.x * x)), .y = (b.y * (x * x + z * z) + y * (2.0 * (-b.w * w - b.x * x - b.z * z) - b.y * y)), .z = (b.z * (x * x + y * y) + z * (2.0 * (-b.w * w - b.x * x - b.y * y) - b.z * z)), .w = b.w * (x * x + y * y + z * z)}; }
    ...
    constexpr Vector Plane::reverseSandwich(const Vector& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y))}; }
    ...
    constexpr ProjectivePoint Bivector::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = (2.0 * (b.w * (-wy * xy - wz * xz) + yz * (b.z * xy - b.y * xz)) + b.x * (yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.w * (wx * xy - wz * yz) + xz * (-b.x * yz - b.z * xy)) + b.y * (xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.w * (wx * xz + wy * yz) + xy * (b.x * yz - b.y * xz)) + b.z * (xy * xy - xz * xz - yz * yz)), .w = b.w * (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector Bivector::reverseSandwich(const Vector& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz))}; }
    constexpr ProjectivePoint Bivector::reverseSandwich(const Point& b) const noexcept { return {.x = (2.0 * (xy * (-wy + b.z * yz) + xz * (-wz - b.y * yz)) + b.x * (yz * yz - xy * xy - xz * xz)), .y = (2.0 * (xy * (wx - b.z * xz) + yz * (-wz - b.x * xz)) + b.y * (xz * xz - xy * xy - yz * yz)), .z = (2.0 * (xz * (wx - b.y * xy) + yz * (wy + b.x * xy)) + b.z * (xy * xy - xz * xz - yz * yz)), .w = (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint Bivector::reverseSandwich(const PointCenter& b) const noexcept { return {.x = 2.0 * (-wy * xy - wz * xz), .y = 2.0 * (wx * xy - wz * yz), .z = 2.0 * (wx * xz + wy * yz), .w = (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint ProjectivePoint::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = w * (-b.x * w + 2.0 * b.w * x), .y = w * (-b.y * w + 2.0 * b.w * y), .z = w * (-b.z * w + 2.0 * b.w * z), .w = b.w * w * w}; }
    ...
    constexpr ProjectivePoint ProjectivePoint::reverseSandwich(const Point& b) const noexcept { return {.x = w * (2.0 * x - b.x * w), .y = w * (2.0 * y - b.y * w), .z = w * (2.0 * z - b.z * w), .w = w * w}; }
    ...
    constexpr ProjectivePoint Quaternion::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = b.w * (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector Quaternion::reverseSandwich(const Vector& b) const noexcept { return {.x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz))}; }
    constexpr ProjectivePoint Quaternion::reverseSandwich(const Point& b) const noexcept { return {.x = (2.0 * (b.y * (-s * xy - xz * yz) + b.z * (xy * yz - s * xz)) + b.x * (s * s + yz * yz - xy * xy - xz * xz)), .y = (2.0 * (b.x * (s * xy - xz * yz) + b.z * (-s * yz - xy * xz)) + b.y * (s * s + xz * xz - xy * xy - yz * yz)), .z = (2.0 * (b.x * (s * xz + xy * yz) + b.y * (s * yz - xy * xz)) + b.z * (s * s + xy * xy - xz * xz - yz * yz)), .w = (s * s + xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr ProjectivePoint ProjectiveTranslator::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = s * (b.x * s + 2.0 * b.w * wx), .y = s * (b.y * s + 2.0 * b.w * wy), .z = s * (b.z * s + 2.0 * b.w * wz), .w = b.w * s * s}; }
    ...
    constexpr ProjectivePoint ProjectiveTranslator::reverseSandwich(const Point& b) const noexcept { return {.x = s * (2.0 * wx + b.x * s), .y = s * (2.0 * wy + b.y * s), .z = s * (2.0 * wz + b.z * s), .w = s * s}; }
    ...
    constexpr ProjectivePoint PlaneIdeal::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y)), .w = b.w * (x * x + y * y + z * z)}; }
    ...
    constexpr Vector PlaneIdeal::reverseSandwich(const Vector& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y))}; }
    constexpr ProjectivePoint PlaneIdeal::reverseSandwich(const Point& b) const noexcept { return {.x = (b.x * (y * y + z * z - x * x) + 2.0 * x * (-b.y * y - b.z * z)), .y = (b.y * (x * x + z * z - y * y) + 2.0 * y * (-b.x * x - b.z * z)), .z = (b.z * (x * x + y * y - z * z) + 2.0 * z * (-b.x * x - b.y * y)), .w = (x * x + y * y + z * z)}; }
    ...
    constexpr ProjectivePoint BivectorBulk::reverseSandwich(const ProjectivePoint& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)), .w = b.w * (xy * xy + xz * xz + yz * yz)}; }
    ...
    constexpr Vector BivectorBulk::reverseSandwich(const Vector& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz))}; }
    constexpr ProjectivePoint BivectorBulk::reverseSandwich(const Point& b) const noexcept { return {.x = (b.x * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.z * xy - b.y * xz)), .y = (b.y * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.x * yz - b.z * xy)), .z = (b.z * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.x * yz - b.y * xz)), .w = (xy * xy + xz * xz + yz * yz)}; }
