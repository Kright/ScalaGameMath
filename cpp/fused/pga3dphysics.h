...
namespace pga3d {
    struct Bivector {
        ...
        // generated by com.github.kright.pga3d.codegen.cpp.binops.BivectorOpsGenerator
        ...
        // generated by com.github.kright.pga3d.codegen.cpp.binops.ProjectionOpsGenerator
...
namespace pga3d {
    ...
    constexpr Motor ProjectivePoint::geometric(const ProjectivePoint& b) const noexcept { return {.s = -b.w * w, .wx = (b.w * x - b.x * w), .wy = (b.w * y - b.y * w), .wz = (b.w * z - b.z * w), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor ProjectivePoint::geometric(const Point& b) const noexcept { return {.s = -w, .wx = (x - b.x * w), .wy = (y - b.y * w), .wz = (z - b.z * w), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor ProjectivePoint::geometric(const PointCenter& b) const noexcept { return {.s = -w, .wx = x, .wy = y, .wz = z, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor Point::geometric(const ProjectivePoint& b) const noexcept { return {.s = -b.w, .wx = (-b.x + b.w * x), .wy = (-b.y + b.w * y), .wz = (-b.z + b.w * z), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor Point::geometric(const Point& b) const noexcept { return {.s = -1.0, .wx = (x - b.x), .wy = (y - b.y), .wz = (z - b.z), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor Point::geometric(const PointCenter& b) const noexcept { return {.s = -1.0, .wx = x, .wy = y, .wz = z, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor PointCenter::geometric(const ProjectivePoint& b) const noexcept { return {.s = -b.w, .wx = -b.x, .wy = -b.y, .wz = -b.z, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor PointCenter::geometric(const Point& b) const noexcept { return {.s = -1.0, .wx = -b.x, .wy = -b.y, .wz = -b.z, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
...
// generated by com.github.kright.pga3d.codegen.cpp.binops.ToStreamOpGenerator
...
namespace pga3d {
    ...
    constexpr Motor Translator::antiGeometric(const PseudoScalar& b) const noexcept { return {.s = b.i, .wx = b.i * wx, .wy = b.i * wy, .wz = b.i * wz, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor PseudoScalar::antiGeometric(const Translator& b) const noexcept { return {.s = i, .wx = b.wx * i, .wy = b.wy * i, .wz = b.wz * i, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
...
namespace pga3d {
    ...
    constexpr Motor Translator::antiDot(const PseudoScalar& b) const noexcept { return {.s = b.i, .wx = b.i * wx, .wy = b.i * wy, .wz = b.i * wz, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor PseudoScalar::antiDot(const Translator& b) const noexcept { return {.s = i, .wx = b.wx * i, .wy = b.wy * i, .wz = b.wz * i, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
...
namespace pga3d {
    ...
    constexpr Motor Plane::sandwich(const Translator& b) const noexcept { return {.s = (x * x + y * y + z * z), .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)), .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)), .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor ProjectivePoint::sandwich(const Translator& b) const noexcept { return {.s = w * w, .wx = -b.wx * w * w, .wy = -b.wy * w * w, .wz = -b.wz * w * w, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor Quaternion::sandwich(const Translator& b) const noexcept { return {.s = (s * s + xy * xy + xz * xz + yz * yz), .wx = (2.0 * (b.wy * (s * xy - xz * yz) + b.wz * (s * xz + xy * yz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)), .wy = (2.0 * (b.wx * (-s * xy - xz * yz) + b.wz * (s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)), .wz = (2.0 * (b.wx * (xy * yz - s * xz) + b.wy * (-s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor PlaneIdeal::sandwich(const Translator& b) const noexcept { return {.s = (x * x + y * y + z * z), .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)), .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)), .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor BivectorBulk::sandwich(const Translator& b) const noexcept { return {.s = (xy * xy + xz * xz + yz * yz), .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)), .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)), .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
...
namespace pga3d {
    ...
    constexpr Motor Plane::reverseSandwich(const Translator& b) const noexcept { return {.s = (x * x + y * y + z * z), .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)), .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)), .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor ProjectivePoint::reverseSandwich(const Translator& b) const noexcept { return {.s = w * w, .wx = -b.wx * w * w, .wy = -b.wy * w * w, .wz = -b.wz * w * w, .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor Quaternion::reverseSandwich(const Translator& b) const noexcept { return {.s = (s * s + xy * xy + xz * xz + yz * yz), .wx = (2.0 * (b.wy * (-s * xy - xz * yz) + b.wz * (xy * yz - s * xz)) + b.wx * (s * s + yz * yz - xy * xy - xz * xz)), .wy = (2.0 * (b.wx * (s * xy - xz * yz) + b.wz * (-s * yz - xy * xz)) + b.wy * (s * s + xz * xz - xy * xy - yz * yz)), .wz = (2.0 * (b.wx * (s * xz + xy * yz) + b.wy * (s * yz - xy * xz)) + b.wz * (s * s + xy * xy - xz * xz - yz * yz)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor PlaneIdeal::reverseSandwich(const Translator& b) const noexcept { return {.s = (x * x + y * y + z * z), .wx = (b.wx * (y * y + z * z - x * x) + 2.0 * x * (-b.wy * y - b.wz * z)), .wy = (b.wy * (x * x + z * z - y * y) + 2.0 * y * (-b.wx * x - b.wz * z)), .wz = (b.wz * (x * x + y * y - z * z) + 2.0 * z * (-b.wx * x - b.wy * y)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
    ...
    constexpr Motor BivectorBulk::reverseSandwich(const Translator& b) const noexcept { return {.s = (xy * xy + xz * xz + yz * yz), .wx = (b.wx * (yz * yz - xy * xy - xz * xz) + 2.0 * yz * (b.wz * xy - b.wy * xz)), .wy = (b.wy * (xz * xz - xy * xy - yz * yz) + 2.0 * xz * (-b.wx * yz - b.wz * xy)), .wz = (b.wz * (xy * xy - xz * xz - yz * yz) + 2.0 * xy * (b.wx * yz - b.wy * xz)), .xy = 0.0, .xz = 0.0, .yz = 0.0, .i = 0.0}; }
